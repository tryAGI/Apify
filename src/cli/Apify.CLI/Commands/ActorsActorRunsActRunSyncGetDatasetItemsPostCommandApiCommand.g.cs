...
internal static partial class ActorsActorRunsActRunSyncGetDatasetItemsPostCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"act-run-sync-get-dataset-items-post", @"Run Actor synchronously and get dataset items
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ActorsActorRuns.ActRunSyncGetDatasetItemsPostAsync(
                                    actorId: actorId,
                                    timeout: timeout,
                                    memory: memory,
                                    maxItems: maxItems,
