...
internal static partial class LastActorRunSDefaultRequestQueueActorRunsLastRequestQueueDeleteCommandApiCommand
{
    ...
    {
        var command = new Command(@"actor-runs-last-request-queue-delete", @"Delete last run's default request queue
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                await client.LastActorRunSDefaultRequestQueue.ActorRunsLastRequestQueueDeleteAsync(
                                    actorId: actorId,
                                    status: status,
                                    origin: origin,
