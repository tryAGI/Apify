...
internal static partial class ActorsActorVersionsActVersionEnvVarsGetCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-version-env-vars-get", @"Get list of environment variables
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ActorsActorVersions.ActVersionEnvVarsGetAsync(
                                    actorId: actorId,
