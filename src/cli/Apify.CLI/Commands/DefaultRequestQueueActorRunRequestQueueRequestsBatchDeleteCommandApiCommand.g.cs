...
internal static partial class DefaultRequestQueueActorRunRequestQueueRequestsBatchDeleteCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"actor-run-request-queue-requests-batch-delete", @"Batch delete requests from default request queue
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.DefaultRequestQueue.ActorRunRequestQueueRequestsBatchDeleteAsync(
                                    runId: runId,
