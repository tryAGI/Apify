...
internal static partial class LastActorRunSMetamorphActRunsLastMetamorphPostCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"act-runs-last-metamorph-post", @"Metamorph Actor's last run
