...
internal static partial class LastActorTaskRunSDefaultRequestQueueActorTaskRunsLastRequestQueuePutCommandApiCommand
{
    ...
    {
        var command = new Command(@"actor-task-runs-last-request-queue-put", @"Update last task run's default request queue
