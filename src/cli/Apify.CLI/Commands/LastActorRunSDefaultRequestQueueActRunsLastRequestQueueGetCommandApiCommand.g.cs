...
internal static partial class LastActorRunSDefaultRequestQueueActRunsLastRequestQueueGetCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-runs-last-request-queue-get", @"Get last run's default request queue
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultRequestQueue.ActRunsLastRequestQueueGetAsync(
                                    actorId: actorId,
                                    status: status,
