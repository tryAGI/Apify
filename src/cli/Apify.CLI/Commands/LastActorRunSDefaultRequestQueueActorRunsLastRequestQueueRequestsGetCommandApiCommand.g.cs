...
internal static partial class LastActorRunSDefaultRequestQueueActorRunsLastRequestQueueRequestsGetCommandApiCommand
{
...
",
    ...
    private static Option<global::System.Collections.Generic.IList<global::Apify.ActorRunsLastRequestQueueRequestsGetFilterItem>?> Filter { get; } = new(
        name: @"--filter")
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultRequestQueue.ActorRunsLastRequestQueueRequestsGetAsync(
                                    actorId: actorId,
                                    status: status,
                                    origin: origin,
                                    clientKey: clientKey,
