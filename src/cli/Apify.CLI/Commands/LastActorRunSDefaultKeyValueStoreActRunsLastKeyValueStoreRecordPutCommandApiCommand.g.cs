...
internal static partial class LastActorRunSDefaultKeyValueStoreActRunsLastKeyValueStoreRecordPutCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-runs-last-key-value-store-record-put", @"Store record in last run's default store
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultKeyValueStore.ActRunsLastKeyValueStoreRecordPutAsync(
                                    actorId: actorId,
                                    recordKey: recordKey,
                                    status: status,
