...
internal static partial class LastActorRunSDefaultDatasetActRunsLastDatasetItemsGetAsStreamCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"act-runs-last-dataset-items-get-as-stream", @"Get last run's dataset items
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = client.LastActorRunSDefaultDataset.ActRunsLastDatasetItemsGetAsStreamAsync(
                                    actorId: actorId,
                                    status: status,
                                    origin: origin,
                                    format: format,
