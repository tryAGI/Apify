...
internal static partial class LastActorTaskRunSDefaultDatasetActorTaskRunsLastDatasetPutCommandApiCommand
{
    ...
    {
        var command = new Command(@"actor-task-runs-last-dataset-put", @"Update last task run's default dataset
