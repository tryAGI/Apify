...
internal static partial class LastActorRunSDefaultDatasetActRunsLastDatasetItemsGetCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"act-runs-last-dataset-items-get", @"Get last run's dataset items
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultDataset.ActRunsLastDatasetItemsGetAsync(
                                    actorId: actorId,
                                    status: status,
                                    origin: origin,
                                    format: format,
