...
internal static partial class ActorsActorRunsActorRunSyncGetDatasetItemsGetCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ActorsActorRuns.ActorRunSyncGetDatasetItemsGetAsync(
                                    actorId: actorId,
                                    timeout: timeout,
                                    memory: memory,
                                    maxItems: maxItems,
