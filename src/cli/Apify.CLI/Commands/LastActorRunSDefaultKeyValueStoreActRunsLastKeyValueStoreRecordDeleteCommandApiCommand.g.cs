...
internal static partial class LastActorRunSDefaultKeyValueStoreActRunsLastKeyValueStoreRecordDeleteCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                await client.LastActorRunSDefaultKeyValueStore.ActRunsLastKeyValueStoreRecordDeleteAsync(
                                    actorId: actorId,
                                    recordKey: recordKey,
                                    status: status,
                                    origin: origin,
