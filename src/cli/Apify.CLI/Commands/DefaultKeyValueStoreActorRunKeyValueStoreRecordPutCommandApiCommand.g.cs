...
internal static partial class DefaultKeyValueStoreActorRunKeyValueStoreRecordPutCommandApiCommand
{
    ...
    {
        var command = new Command(@"actor-run-key-value-store-record-put", @"Store record in default store
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.DefaultKeyValueStore.ActorRunKeyValueStoreRecordPutAsync(
                                    runId: runId,
                                    recordKey: recordKey,
