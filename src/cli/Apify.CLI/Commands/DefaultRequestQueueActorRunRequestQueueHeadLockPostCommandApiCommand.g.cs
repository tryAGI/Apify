...
internal static partial class DefaultRequestQueueActorRunRequestQueueHeadLockPostCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.DefaultRequestQueue.ActorRunRequestQueueHeadLockPostAsync(
                                    runId: runId,
                                    lockSecs: lockSecs,
                                    limit: limit,
                                    clientKey: clientKey,
