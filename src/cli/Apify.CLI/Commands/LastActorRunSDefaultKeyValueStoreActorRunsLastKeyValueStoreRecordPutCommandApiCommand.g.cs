...
internal static partial class LastActorRunSDefaultKeyValueStoreActorRunsLastKeyValueStoreRecordPutCommandApiCommand
{
    ...
    private static Option<global::Apify.ActorRunsLastKeyValueStoreRecordPutContentEncoding?> ContentEncoding { get; } = new(
    ...
    {
        var command = new Command(@"actor-runs-last-key-value-store-record-put", @"Store record in last run's default store
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultKeyValueStore.ActorRunsLastKeyValueStoreRecordPutAsync(
                                    actorId: actorId,
                                    recordKey: recordKey,
                                    status: status,
                                    origin: origin,
