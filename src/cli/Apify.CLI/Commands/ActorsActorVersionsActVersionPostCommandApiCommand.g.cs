...
internal static partial class ActorsActorVersionsActVersionPostCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-version-post", @"Update version (POST)
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ActorsActorVersions.ActVersionPostAsync(
                                    actorId: actorId,
