...
internal static partial class ActorsActorVersionsActVersionDeleteCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-version-delete", @"Delete version
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ActorsActorVersions.ActVersionDeleteAsync(
                                    actorId: actorId,
