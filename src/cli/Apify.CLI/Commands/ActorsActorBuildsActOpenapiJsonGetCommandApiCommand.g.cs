...
internal static partial class ActorsActorBuildsActOpenapiJsonGetCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"act-openapi-json-get", @"Get OpenAPI definition
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ActorsActorBuilds.ActOpenapiJsonGetAsync(
                                    actorId: actorId,
                                    buildId: buildId,
