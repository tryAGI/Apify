...
internal static partial class LastActorTaskRunSDefaultRequestQueueActorTaskRunsLastRequestQueueRequestsBatchDeleteCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"actor-task-runs-last-request-queue-requests-batch-delete", @"Batch delete requests from last task run's default request queue
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorTaskRunSDefaultRequestQueue.ActorTaskRunsLastRequestQueueRequestsBatchDeleteAsync(
