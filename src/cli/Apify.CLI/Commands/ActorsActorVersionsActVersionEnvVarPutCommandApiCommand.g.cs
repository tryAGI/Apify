...
internal static partial class ActorsActorVersionsActVersionEnvVarPutCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-version-env-var-put", @"Update environment variable
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ActorsActorVersions.ActVersionEnvVarPutAsync(
                                    actorId: actorId,
