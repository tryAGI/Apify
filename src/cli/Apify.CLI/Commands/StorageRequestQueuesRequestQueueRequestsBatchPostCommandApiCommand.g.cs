...
internal static partial class StorageRequestQueuesRequestQueueRequestsBatchPostCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.StorageRequestQueues.RequestQueueRequestsBatchPostAsync(
                                    queueId: queueId,
                                    clientKey: clientKey,
                                    forefront: forefront,
                                    request: request,
