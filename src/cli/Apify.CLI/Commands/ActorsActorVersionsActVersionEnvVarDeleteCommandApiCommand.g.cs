...
internal static partial class ActorsActorVersionsActVersionEnvVarDeleteCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-version-env-var-delete", @"Delete environment variable
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ActorsActorVersions.ActVersionEnvVarDeleteAsync(
                                    actorId: actorId,
