...
internal static partial class LastActorTaskRunSDefaultRequestQueueActorTaskRunsLastRequestQueueRequestsGetCommandApiCommand
{
...
",
    ...
    private static Option<global::System.Collections.Generic.IList<global::Apify.ActorTaskRunsLastRequestQueueRequestsGetFilterItem>?> Filter { get; } = new(
        name: @"--filter")
    {
    ...
    {
        var command = new Command(@"actor-task-runs-last-request-queue-requests-get", @"List last task run's default request queue's requests
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorTaskRunSDefaultRequestQueue.ActorTaskRunsLastRequestQueueRequestsGetAsync(
