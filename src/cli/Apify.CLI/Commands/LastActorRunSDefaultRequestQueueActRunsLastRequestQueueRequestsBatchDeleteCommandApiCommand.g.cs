...
internal static partial class LastActorRunSDefaultRequestQueueActRunsLastRequestQueueRequestsBatchDeleteCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"act-runs-last-request-queue-requests-batch-delete", @"Batch delete requests from last run's default request queue
