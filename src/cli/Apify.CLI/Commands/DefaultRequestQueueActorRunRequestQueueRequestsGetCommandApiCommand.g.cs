...
internal static partial class DefaultRequestQueueActorRunRequestQueueRequestsGetCommandApiCommand
{
...
",
    ...
    private static Option<global::System.Collections.Generic.IList<global::Apify.ActorRunRequestQueueRequestsGetFilterItem>?> Filter { get; } = new(
        name: @"--filter")
    {
    ...
    {
        var command = new Command(@"actor-run-request-queue-requests-get", @"List default request queue's requests
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.DefaultRequestQueue.ActorRunRequestQueueRequestsGetAsync(
                                    runId: runId,
                                    clientKey: clientKey,
