...
internal static partial class LastActorRunSDefaultDatasetActorRunsLastDatasetItemsGetAsTextCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"actor-runs-last-dataset-items-get-as-text", @"Get last run's dataset items
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultDataset.ActorRunsLastDatasetItemsGetAsTextAsync(
                                    actorId: actorId,
                                    status: status,
                                    origin: origin,
                                    format: format,
