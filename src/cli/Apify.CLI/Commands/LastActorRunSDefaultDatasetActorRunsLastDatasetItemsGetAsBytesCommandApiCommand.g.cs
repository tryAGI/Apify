...
internal static partial class LastActorRunSDefaultDatasetActorRunsLastDatasetItemsGetAsBytesCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultDataset.ActorRunsLastDatasetItemsGetAsBytesAsync(
                                    actorId: actorId,
                                    status: status,
                                    origin: origin,
                                    format: format,
