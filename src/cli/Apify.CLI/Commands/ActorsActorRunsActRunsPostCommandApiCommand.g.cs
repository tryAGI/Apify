...
internal static partial class ActorsActorRunsActRunsPostCommandApiCommand
{
...
",
    ...
    private static Option<global::Apify.ActRunsPostForcePermissionLevel?> ForcePermissionLevel { get; } = new(
...
",
    ...
    {
        var command = new Command(@"act-runs-post", @"Run Actor
