...
internal static partial class StorageKeyValueStoresKeyValueStorePutCommandApiCommand
{
...
");
                        command.Arguments.Add(StoreId);                        command.Options.Add(UpdateStoreRequestOptionSetOptions.NameOption);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                        ...
                        var storeId = parseResult.GetRequiredValue(StoreId);                        var name = CliRuntime.WasSpecified(parseResult, UpdateStoreRequestOptionSetOptions.NameOption) ? parseResult.GetValue(UpdateStoreRequestOptionSetOptions.NameOption) : (__requestBase is { } __NameBaseValue ? __NameBaseValue.Name : default);
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.StorageKeyValueStores.KeyValueStorePutAsync(
                                    storeId: storeId,
                                    name: name,
