...
internal static partial class SchedulesSchedulesGetCommandApiCommand
{
...
");
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Apify.ListOfSchedulesResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Apify.ListOfSchedulesResponse value, ref string? text);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.Schedules.SchedulesGetAsync(
                                    offset: offset,
                                    limit: limit,
                                    desc: desc,
