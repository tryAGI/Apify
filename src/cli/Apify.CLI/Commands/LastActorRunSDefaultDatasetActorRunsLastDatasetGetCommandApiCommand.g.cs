...
internal static partial class LastActorRunSDefaultDatasetActorRunsLastDatasetGetCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultDataset.ActorRunsLastDatasetGetAsync(
                                    actorId: actorId,
                                    status: status,
                                    origin: origin,
