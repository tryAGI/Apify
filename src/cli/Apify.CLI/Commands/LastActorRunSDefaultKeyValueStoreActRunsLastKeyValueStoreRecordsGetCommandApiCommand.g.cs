...
internal static partial class LastActorRunSDefaultKeyValueStoreActRunsLastKeyValueStoreRecordsGetCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"act-runs-last-key-value-store-records-get", @"Download last run's default store's records
