...
internal static partial class ActorsActorVersionsActVersionEnvVarsPostCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-version-env-vars-post", @"Create environment variable
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ActorsActorVersions.ActVersionEnvVarsPostAsync(
                                    actorId: actorId,
