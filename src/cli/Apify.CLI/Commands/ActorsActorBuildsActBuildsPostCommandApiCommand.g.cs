...
internal static partial class ActorsActorBuildsActBuildsPostCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"act-builds-post", @"Build Actor
Builds an Actor.
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ActorsActorBuilds.ActBuildsPostAsync(
                                    actorId: actorId,
                                    version: version,
                                    useCache: useCache,
