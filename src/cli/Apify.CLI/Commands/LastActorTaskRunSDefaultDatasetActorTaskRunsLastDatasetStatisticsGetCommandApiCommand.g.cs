...
internal static partial class LastActorTaskRunSDefaultDatasetActorTaskRunsLastDatasetStatisticsGetCommandApiCommand
{
    ...
    {
        var command = new Command(@"actor-task-runs-last-dataset-statistics-get", @"Get last task run's dataset statistics
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorTaskRunSDefaultDataset.ActorTaskRunsLastDatasetStatisticsGetAsync(
