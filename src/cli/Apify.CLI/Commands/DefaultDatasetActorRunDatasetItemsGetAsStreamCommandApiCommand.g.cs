...
internal static partial class DefaultDatasetActorRunDatasetItemsGetAsStreamCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"actor-run-dataset-items-get-as-stream", @"Get default dataset items
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = client.DefaultDataset.ActorRunDatasetItemsGetAsStreamAsync(
                                    runId: runId,
                                    format: format,
                                    clean: clean,
                                    offset: offset,
