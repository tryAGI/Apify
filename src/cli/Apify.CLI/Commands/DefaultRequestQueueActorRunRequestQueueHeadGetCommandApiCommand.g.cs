...
internal static partial class DefaultRequestQueueActorRunRequestQueueHeadGetCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"actor-run-request-queue-head-get", @"Get default request queue head
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.DefaultRequestQueue.ActorRunRequestQueueHeadGetAsync(
                                    runId: runId,
                                    limit: limit,
                                    clientKey: clientKey,
