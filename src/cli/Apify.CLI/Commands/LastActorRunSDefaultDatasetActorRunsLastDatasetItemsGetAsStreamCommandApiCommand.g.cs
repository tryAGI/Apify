...
internal static partial class LastActorRunSDefaultDatasetActorRunsLastDatasetItemsGetAsStreamCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = client.LastActorRunSDefaultDataset.ActorRunsLastDatasetItemsGetAsStreamAsync(
                                    actorId: actorId,
                                    status: status,
                                    origin: origin,
                                    format: format,
