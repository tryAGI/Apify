...
internal static partial class LastActorRunSDefaultRequestQueueActorRunsLastRequestQueueRequestsUnlockPostCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"actor-runs-last-request-queue-requests-unlock-post", @"Unlock requests in last run's default request queue
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultRequestQueue.ActorRunsLastRequestQueueRequestsUnlockPostAsync(
                                    actorId: actorId,
                                    status: status,
                                    origin: origin,
                                    clientKey: clientKey,
