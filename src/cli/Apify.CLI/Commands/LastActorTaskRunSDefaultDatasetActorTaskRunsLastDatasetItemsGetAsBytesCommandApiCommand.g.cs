...
internal static partial class LastActorTaskRunSDefaultDatasetActorTaskRunsLastDatasetItemsGetAsBytesCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"actor-task-runs-last-dataset-items-get-as-bytes", @"Get last task run's dataset items
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorTaskRunSDefaultDataset.ActorTaskRunsLastDatasetItemsGetAsBytesAsync(
