...
internal static partial class LastActorRunSDefaultKeyValueStoreActorRunsLastKeyValueStoreGetCommandApiCommand
{
    ...
    {
        var command = new Command(@"actor-runs-last-key-value-store-get", @"Get last run's default store
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultKeyValueStore.ActorRunsLastKeyValueStoreGetAsync(
                                    actorId: actorId,
                                    status: status,
                                    origin: origin,
