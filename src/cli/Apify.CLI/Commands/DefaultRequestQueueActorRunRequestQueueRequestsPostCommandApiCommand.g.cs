...
internal static partial class DefaultRequestQueueActorRunRequestQueueRequestsPostCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.DefaultRequestQueue.ActorRunRequestQueueRequestsPostAsync(
                                    runId: runId,
                                    clientKey: clientKey,
                                    forefront: forefront,
                                    headers: headers,
