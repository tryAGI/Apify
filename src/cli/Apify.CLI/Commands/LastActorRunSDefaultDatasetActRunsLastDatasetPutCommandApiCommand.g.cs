...
internal static partial class LastActorRunSDefaultDatasetActRunsLastDatasetPutCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-runs-last-dataset-put", @"Update last run's default dataset
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultDataset.ActRunsLastDatasetPutAsync(
                                    actorId: actorId,
                                    status: status,
                                    name: name,
