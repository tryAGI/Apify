...
internal static partial class LastActorRunSDefaultKeyValueStoreActRunsLastKeyValueStoreRecordPostCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-runs-last-key-value-store-record-post", @"Store record in last run's default store (POST)
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultKeyValueStore.ActRunsLastKeyValueStoreRecordPostAsync(
                                    actorId: actorId,
                                    recordKey: recordKey,
                                    status: status,
