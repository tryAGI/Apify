...
internal static partial class DefaultRequestQueueActorRunRequestQueueRequestPutCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"actor-run-request-queue-request-put", @"Update request in default request queue
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.DefaultRequestQueue.ActorRunRequestQueueRequestPutAsync(
                                    runId: runId,
                                    requestId: requestId,
                                    forefront: forefront,
                                    clientKey: clientKey,
