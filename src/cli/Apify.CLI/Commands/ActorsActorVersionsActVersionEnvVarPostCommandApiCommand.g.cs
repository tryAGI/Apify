...
internal static partial class ActorsActorVersionsActVersionEnvVarPostCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-version-env-var-post", @"Update environment variable (POST)
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.ActorsActorVersions.ActVersionEnvVarPostAsync(
                                    actorId: actorId,
