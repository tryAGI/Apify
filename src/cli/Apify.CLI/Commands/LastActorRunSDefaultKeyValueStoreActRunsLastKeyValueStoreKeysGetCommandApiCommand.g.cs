...
internal static partial class LastActorRunSDefaultKeyValueStoreActRunsLastKeyValueStoreKeysGetCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-runs-last-key-value-store-keys-get", @"Get last run's default store's list of keys
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultKeyValueStore.ActRunsLastKeyValueStoreKeysGetAsync(
                                    actorId: actorId,
                                    status: status,
