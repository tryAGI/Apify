...
internal static partial class LastActorRunSDefaultRequestQueueActorRunsLastRequestQueueRequestDeleteCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"actor-runs-last-request-queue-request-delete", @"Delete request from last run's default request queue
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                await client.LastActorRunSDefaultRequestQueue.ActorRunsLastRequestQueueRequestDeleteAsync(
                                    actorId: actorId,
                                    requestId: requestId,
                                    status: status,
                                    origin: origin,
