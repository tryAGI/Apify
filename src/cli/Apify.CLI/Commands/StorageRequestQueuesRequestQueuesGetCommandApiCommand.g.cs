...
internal static partial class StorageRequestQueuesRequestQueuesGetCommandApiCommand
{
...
",
                    ...
                    private static string FormatResponse(ParseResult parseResult, global::Apify.ListOfRequestQueuesResponse value, global::System.Text.Json.Serialization.JsonSerializerContext context, bool truncateLongStrings)
                    {
                        string? text = null;
                    ...
                    static partial void CustomizeResponseText(ParseResult parseResult, global::Apify.ListOfRequestQueuesResponse value, ref string? text);
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.StorageRequestQueues.RequestQueuesGetAsync(
                                    offset: offset,
                                    limit: limit,
                                    desc: desc,
                                    unnamed: unnamed,
