...
internal static partial class LastActorRunSDefaultRequestQueueActRunsLastRequestQueueRequestsPostCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"act-runs-last-request-queue-requests-post", @"Add request to last run's default request queue
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultRequestQueue.ActRunsLastRequestQueueRequestsPostAsync(
                                    actorId: actorId,
                                    status: status,
                                    clientKey: clientKey,
                                    forefront: forefront,
