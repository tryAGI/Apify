...
internal static partial class LastActorRunSDefaultRequestQueueActRunsLastRequestQueueHeadGetCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"act-runs-last-request-queue-head-get", @"Get last run's default request queue head
