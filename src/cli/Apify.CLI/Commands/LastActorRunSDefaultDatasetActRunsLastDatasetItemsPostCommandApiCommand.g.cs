...
internal static partial class LastActorRunSDefaultDatasetActRunsLastDatasetItemsPostCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-runs-last-dataset-items-post", @"Store items in last run's dataset
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultDataset.ActRunsLastDatasetItemsPostAsync(
                                    actorId: actorId,
                                    status: status,
                                    request: request,
