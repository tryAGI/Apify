...
internal static partial class StorageDatasetsDatasetItemsGetAsStreamCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"dataset-items-get-as-stream", @"Get dataset items
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = client.StorageDatasets.DatasetItemsGetAsStreamAsync(
                                    datasetId: datasetId,
                                    format: format,
                                    clean: clean,
                                    offset: offset,
