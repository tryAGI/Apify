...
internal static partial class LastActorRunSDefaultRequestQueueActRunsLastRequestQueueHeadLockPostCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"act-runs-last-request-queue-head-lock-post", @"Get and lock last run's default request queue head
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultRequestQueue.ActRunsLastRequestQueueHeadLockPostAsync(
                                    actorId: actorId,
                                    status: status,
                                    origin: origin,
                                    lockSecs: lockSecs,
