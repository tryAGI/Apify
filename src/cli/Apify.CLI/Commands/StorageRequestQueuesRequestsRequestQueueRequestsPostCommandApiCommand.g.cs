...
internal static partial class StorageRequestQueuesRequestsRequestQueueRequestsPostCommandApiCommand
{
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.StorageRequestQueuesRequests.RequestQueueRequestsPostAsync(
                                    queueId: queueId,
                                    clientKey: clientKey,
                                    forefront: forefront,
                                    uniqueKey: uniqueKey,
