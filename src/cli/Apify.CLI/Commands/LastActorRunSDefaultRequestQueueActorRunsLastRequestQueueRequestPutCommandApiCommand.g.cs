...
internal static partial class LastActorRunSDefaultRequestQueueActorRunsLastRequestQueueRequestPutCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"actor-runs-last-request-queue-request-put", @"Update request in last run's default request queue
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultRequestQueue.ActorRunsLastRequestQueueRequestPutAsync(
                                    actorId: actorId,
                                    requestId: requestId,
                                    status: status,
                                    origin: origin,
