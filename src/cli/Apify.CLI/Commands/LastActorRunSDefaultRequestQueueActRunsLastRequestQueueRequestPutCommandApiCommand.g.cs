...
internal static partial class LastActorRunSDefaultRequestQueueActRunsLastRequestQueueRequestPutCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"act-runs-last-request-queue-request-put", @"Update request in last run's default request queue
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultRequestQueue.ActRunsLastRequestQueueRequestPutAsync(
                                    actorId: actorId,
                                    requestId: requestId,
                                    status: status,
                                    forefront: forefront,
