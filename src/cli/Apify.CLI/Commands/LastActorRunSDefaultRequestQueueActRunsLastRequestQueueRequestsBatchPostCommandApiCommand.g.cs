...
internal static partial class LastActorRunSDefaultRequestQueueActRunsLastRequestQueueRequestsBatchPostCommandApiCommand
{
...
",
    ...
    {
        var command = new Command(@"act-runs-last-request-queue-requests-batch-post", @"Batch add requests to last run's default request queue
