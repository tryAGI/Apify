...
internal static partial class StorageRequestQueuesRequestsRequestQueueRequestsGetCommandApiCommand
{
...
",
    ...
    private static Option<global::System.Collections.Generic.IList<global::Apify.RequestQueueRequestsGetFilterItem>?> Filter { get; } = new(
        name: @"--filter")
    {
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.StorageRequestQueuesRequests.RequestQueueRequestsGetAsync(
                                    queueId: queueId,
                                    clientKey: clientKey,
