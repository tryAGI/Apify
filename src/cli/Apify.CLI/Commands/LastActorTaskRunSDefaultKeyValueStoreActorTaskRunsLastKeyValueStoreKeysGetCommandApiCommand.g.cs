...
internal static partial class LastActorTaskRunSDefaultKeyValueStoreActorTaskRunsLastKeyValueStoreKeysGetCommandApiCommand
{
    ...
    {
        var command = new Command(@"actor-task-runs-last-key-value-store-keys-get", @"Get last task run's default store's list of keys
