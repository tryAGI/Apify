...
internal static partial class LastActorRunSDefaultDatasetActRunsLastDatasetGetCommandApiCommand
{
    ...
    {
        var command = new Command(@"act-runs-last-dataset-get", @"Get last run's default dataset
        ...
        command.SetAction(async (ParseResult parseResult, CancellationToken cancellationToken) =>
            await CliRuntime.RunAsync(async () =>
            {
                ...
                using var client = await CliRuntime.CreateClientAsync(parseResult, cancellationToken).ConfigureAwait(false);
                                ...
                                var response = await client.LastActorRunSDefaultDataset.ActRunsLastDatasetGetAsync(
                                    actorId: actorId,
                                    status: status,
