...
internal static partial class LastActorRunSLogActRunsLastLogGetCommandApiCommand
{
...
");
    ...
    {
        var command = new Command(@"act-runs-last-log-get", @"Get last Actor run's log
