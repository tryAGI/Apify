...
{
    private const string UserSecretsId = "Apify.CLI";
    private const string UserSecretApiKeyName = "APIFY_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"APIFY_API_KEY"];
    private const string CredentialFileDirectoryName = ".apify";

    public static async global::System.Threading.Tasks.Task<global::Apify.ApifyClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Apify.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Apify.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Apify.ApifyClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Apify.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Apify.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Apify.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Apify.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("APIFY_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Apify.ApiException exception)
    {
        var builder = new StringBuilder();
