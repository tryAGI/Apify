...
namespace Apify
{
    public partial class LastActorRunSDefaultKeyValueStoreClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunsLastKeyValueStorePutSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunsLastKeyValueStorePutSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunsLastKeyValueStorePutSecurityRequirement0,
            };
        partial void PrepareActorRunsLastKeyValueStorePutArguments(
        ...
        partial void ProcessActorRunsLastKeyValueStorePutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await ActorRunsLastKeyValueStorePutAsResponseAsync(
                actorId: actorId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunsLastKeyValueStorePutArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunsLastKeyValueStorePutSecurityRequirements,
                operationName: "ActorRunsLastKeyValueStorePutAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunsLastKeyValueStorePutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunsLastKeyValueStorePut",
                                methodName: "ActorRunsLastKeyValueStorePutAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunsLastKeyValueStorePutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunsLastKeyValueStorePutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ActorRunsLastKeyValueStorePutAsync(
                actorId: actorId,
                status: status,
                origin: origin,
                request: __request,
