...
namespace Apify
{
    public sealed partial class DefaultKeyValueStoreClient
    {
        /// <inheritdoc cref="DefaultKeyValueStoreClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::Apify.EndPointAuthorization}?, bool)"/>

        public DefaultKeyValueStoreClient(
            string apiKey,
        ...
        /// <summary>
        /// Creates an authenticated DefaultKeyValueStoreClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static DefaultKeyValueStoreClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Apify.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new DefaultKeyValueStoreClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated DefaultKeyValueStoreClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out DefaultKeyValueStoreClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Apify.EndPointAuthorization>? authorizations = null,
            global::Apify.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new DefaultKeyValueStoreClient(
                httpClient,
                baseUri,
                authorizations,
                options,
