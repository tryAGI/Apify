...
{
    /// <inheritdoc />
    public class DeletedRequestJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Apify.DeletedRequest>
    {
        /// <inheritdoc />
        public override global::Apify.DeletedRequest Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Apify.DeletedRequestById? deletedRequestById = default;
            global::Apify.DeletedRequestByUniqueKey? deletedRequestByUniqueKey = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Apify.DeletedRequest(
                deletedRequestById,
        ...
        public override void Write(
            ...
            global::Apify.DeletedRequest value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsDeletedRequestById)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Apify.DeletedRequestById), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Apify.DeletedRequestById?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Apify.DeletedRequestById).Name}");
