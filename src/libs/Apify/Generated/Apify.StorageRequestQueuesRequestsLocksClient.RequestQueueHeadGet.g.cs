...
namespace Apify
{
    public partial class StorageRequestQueuesRequestsLocksClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_RequestQueueHeadGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_RequestQueueHeadGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_RequestQueueHeadGetSecurityRequirement0,
            };
        partial void PrepareRequestQueueHeadGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string queueId,
            ref double? limit,
            ref string? clientKey);
        partial void PrepareRequestQueueHeadGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string queueId,
            double? limit,
            string? clientKey);
        partial void ProcessRequestQueueHeadGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRequestQueueHeadGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.HeadResponse> RequestQueueHeadGetAsync(
            string queueId,
        ...
        {
            var __response = await RequestQueueHeadGetAsResponseAsync(
                queueId: queueId,
                limit: limit,
                clientKey: clientKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.HeadResponse>> RequestQueueHeadGetAsResponseAsync(
            string queueId,
            double? limit = default,
            string? clientKey = default,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRequestQueueHeadGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RequestQueueHeadGetSecurityRequirements,
                operationName: "RequestQueueHeadGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRequestQueueHeadGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RequestQueueHeadGet",
                                methodName: "RequestQueueHeadGetAsync",
                                pathTemplate: "$\"/v2/request-queues/{queueId}/head\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRequestQueueHeadGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRequestQueueHeadGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
