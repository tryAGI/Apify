...
namespace Apify
{
    public partial interface ILastActorTaskRunSDefaultDatasetClient
    {
        ...
        global::System.Threading.Tasks.Task<string> ActorTaskRunsLastDatasetItemsGetAsTextAsync(
            string actorTaskId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> ActorTaskRunsLastDatasetItemsGetAsTextAsResponseAsync(
            string actorTaskId,
            string? status = default,
            global::Apify.RunOrigin? origin = default,
            string? format = default,
