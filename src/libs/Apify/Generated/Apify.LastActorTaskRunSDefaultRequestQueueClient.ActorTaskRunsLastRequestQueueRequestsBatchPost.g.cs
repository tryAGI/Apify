...
namespace Apify
{
    public partial class LastActorTaskRunSDefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorTaskRunsLastRequestQueueRequestsBatchPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorTaskRunsLastRequestQueueRequestsBatchPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorTaskRunsLastRequestQueueRequestsBatchPostSecurityRequirement0,
            };
        partial void PrepareActorTaskRunsLastRequestQueueRequestsBatchPostArguments(
        ...
        partial void PrepareActorTaskRunsLastRequestQueueRequestsBatchPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? forefront,
            global::System.Collections.Generic.IList<global::Apify.RequestBase> request);
        partial void ProcessActorTaskRunsLastRequestQueueRequestsBatchPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorTaskRunsLastRequestQueueRequestsBatchPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.BatchAddResponse> ActorTaskRunsLastRequestQueueRequestsBatchPostAsync(
            string actorTaskId,
        ...
        {
            var __response = await ActorTaskRunsLastRequestQueueRequestsBatchPostAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.BatchAddResponse>> ActorTaskRunsLastRequestQueueRequestsBatchPostAsResponseAsync(
            string actorTaskId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareActorTaskRunsLastRequestQueueRequestsBatchPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorTaskRunsLastRequestQueueRequestsBatchPostSecurityRequirements,
                operationName: "ActorTaskRunsLastRequestQueueRequestsBatchPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorTaskRunsLastRequestQueueRequestsBatchPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorTaskRunsLastRequestQueueRequestsBatchPost",
                                methodName: "ActorTaskRunsLastRequestQueueRequestsBatchPostAsync",
                                pathTemplate: "$\"/v2/actor-tasks/{actorTaskId}/runs/last/request-queue/requests/batch\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorTaskRunsLastRequestQueueRequestsBatchPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorTaskRunsLastRequestQueueRequestsBatchPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Apify.BatchAddResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Apify.AutoSDKHttpResponse<global::Apify.BatchAddResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Apify.BatchAddResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
