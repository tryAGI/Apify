...
namespace Apify
{
    public partial interface ILastActorRunSDefaultRequestQueueClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Apify.ProlongRequestLockResponse> ActRunsLastRequestQueueRequestLockPutAsync(
            string actorId,
            string requestId,
            double lockSecs,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ProlongRequestLockResponse>> ActRunsLastRequestQueueRequestLockPutAsResponseAsync(
            string actorId,
            string requestId,
            double lockSecs,
            string? status = default,
