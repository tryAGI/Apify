...
namespace Apify
{
    public partial interface ILastActorRunSLogClient
    {
        ...
        global::System.Threading.Tasks.Task<string> ActorRunsLastLogGetAsync(
            string actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> ActorRunsLastLogGetAsResponseAsync(
            string actorId,
            string? status = default,
            global::Apify.RunOrigin? origin = default,
            bool? stream = default,
