...
namespace Apify
{
    public partial class LastActorRunSDefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActRunsLastRequestQueueHeadGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActRunsLastRequestQueueHeadGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActRunsLastRequestQueueHeadGetSecurityRequirement0,
            };
        partial void PrepareActRunsLastRequestQueueHeadGetArguments(
        ...
        partial void PrepareActRunsLastRequestQueueHeadGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            double? limit,
            string? clientKey);
        partial void ProcessActRunsLastRequestQueueHeadGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActRunsLastRequestQueueHeadGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.HeadResponse> ActRunsLastRequestQueueHeadGetAsync(
            string actorId,
        ...
        {
            var __response = await ActRunsLastRequestQueueHeadGetAsResponseAsync(
                actorId: actorId,
                status: status,
                origin: origin,
                limit: limit,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.HeadResponse>> ActRunsLastRequestQueueHeadGetAsResponseAsync(
            string actorId,
            string? status = default,
            global::Apify.RunOrigin? origin = default,
            double? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActRunsLastRequestQueueHeadGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActRunsLastRequestQueueHeadGetSecurityRequirements,
                operationName: "ActRunsLastRequestQueueHeadGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActRunsLastRequestQueueHeadGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActRunsLastRequestQueueHeadGet",
                                methodName: "ActRunsLastRequestQueueHeadGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActRunsLastRequestQueueHeadGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActRunsLastRequestQueueHeadGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
