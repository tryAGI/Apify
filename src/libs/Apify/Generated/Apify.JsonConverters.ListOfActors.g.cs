...
{
    /// <inheritdoc />
    public class ListOfActorsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Apify.ListOfActors>
    {
        /// <inheritdoc />
        public override global::Apify.ListOfActors Read(
        ...
        public override void Write(
            ...
            global::Apify.ListOfActors value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            if (value.IsListOfActorsVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Apify.ListOfActorsVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Apify.ListOfActorsVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Apify.ListOfActorsVariant2).Name}");
                var __element1 = global::System.Text.Json.JsonSerializer.SerializeToElement(value.ListOfActorsVariant2!, typeInfo);
