...
namespace Apify
{
    public partial class ActorsActorRunsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunResurrectPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunResurrectPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunResurrectPostSecurityRequirement0,
            };
        partial void PrepareActorRunResurrectPostArguments(
        ...
        partial void PrepareActorRunResurrectPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            double? memory,
            bool? restartOnError);
        partial void ProcessActorRunResurrectPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunResurrectPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.RunResponse> ActorRunResurrectPostAsync(
            string actorId,
            string runId,
        ...
        {
            var __response = await ActorRunResurrectPostAsResponseAsync(
                actorId: actorId,
                runId: runId,
                build: build,
                timeout: timeout,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.RunResponse>> ActorRunResurrectPostAsResponseAsync(
            string actorId,
            string runId,
            string? build = default,
            double? timeout = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunResurrectPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunResurrectPostSecurityRequirements,
                operationName: "ActorRunResurrectPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunResurrectPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunResurrectPost",
                                methodName: "ActorRunResurrectPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunResurrectPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunResurrectPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
