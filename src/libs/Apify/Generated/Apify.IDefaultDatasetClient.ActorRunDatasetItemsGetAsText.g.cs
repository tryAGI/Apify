...
namespace Apify
{
    public partial interface IDefaultDatasetClient
    {
        ...
        global::System.Threading.Tasks.Task<string> ActorRunDatasetItemsGetAsTextAsync(
            string runId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> ActorRunDatasetItemsGetAsTextAsResponseAsync(
            string runId,
            string? format = default,
            bool? clean = default,
            double? offset = default,
