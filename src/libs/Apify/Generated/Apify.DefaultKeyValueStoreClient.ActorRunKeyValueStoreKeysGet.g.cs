...
namespace Apify
{
    public partial class DefaultKeyValueStoreClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunKeyValueStoreKeysGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunKeyValueStoreKeysGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunKeyValueStoreKeysGetSecurityRequirement0,
            };
        partial void PrepareActorRunKeyValueStoreKeysGetArguments(
        ...
        partial void PrepareActorRunKeyValueStoreKeysGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? prefix,
            string? signature);
        partial void ProcessActorRunKeyValueStoreKeysGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunKeyValueStoreKeysGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.ListOfKeysResponse> ActorRunKeyValueStoreKeysGetAsync(
            string runId,
        ...
        {
            var __response = await ActorRunKeyValueStoreKeysGetAsResponseAsync(
                runId: runId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ListOfKeysResponse>> ActorRunKeyValueStoreKeysGetAsResponseAsync(
            string runId,
            string? exclusiveStartKey = default,
            double? limit = default,
            string? collection = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunKeyValueStoreKeysGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunKeyValueStoreKeysGetSecurityRequirements,
                operationName: "ActorRunKeyValueStoreKeysGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunKeyValueStoreKeysGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunKeyValueStoreKeysGet",
                                methodName: "ActorRunKeyValueStoreKeysGetAsync",
                                pathTemplate: "$\"/v2/actor-runs/{runId}/key-value-store/keys\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunKeyValueStoreKeysGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunKeyValueStoreKeysGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
