...
namespace Apify
{
    public partial class SchedulesClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_SchedulePutSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_SchedulePutSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_SchedulePutSecurityRequirement0,
            };
        ...
        partial void ProcessSchedulePutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await SchedulePutAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SchedulePutSecurityRequirements,
                operationName: "SchedulePutAsync");
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSchedulePutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
