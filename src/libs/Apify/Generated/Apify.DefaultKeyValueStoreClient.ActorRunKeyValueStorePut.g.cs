...
namespace Apify
{
    public partial class DefaultKeyValueStoreClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunKeyValueStorePutSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunKeyValueStorePutSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunKeyValueStorePutSecurityRequirement0,
            };
        partial void PrepareActorRunKeyValueStorePutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string runId,
            global::Apify.UpdateStoreRequest request);
        partial void PrepareActorRunKeyValueStorePutRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string runId,
            global::Apify.UpdateStoreRequest request);
        partial void ProcessActorRunKeyValueStorePutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunKeyValueStorePutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Update default store<br/>
        /// Updates the default key-value store's name and general resource access level using a value specified by a JSON object<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.KeyValueStoreResponse> ActorRunKeyValueStorePutAsync(
            string runId,
        ...
        {
            var __response = await ActorRunKeyValueStorePutAsResponseAsync(
                runId: runId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.KeyValueStoreResponse>> ActorRunKeyValueStorePutAsResponseAsync(
            string runId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunKeyValueStorePutArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunKeyValueStorePutSecurityRequirements,
                operationName: "ActorRunKeyValueStorePutAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunKeyValueStorePut",
                                methodName: "ActorRunKeyValueStorePutAsync",
                                pathTemplate: "$\"/v2/actor-runs/{runId}/key-value-store\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunKeyValueStorePutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunKeyValueStorePutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ActorRunKeyValueStorePutAsync(
                runId: runId,
                request: __request,
                requestOptions: requestOptions,
