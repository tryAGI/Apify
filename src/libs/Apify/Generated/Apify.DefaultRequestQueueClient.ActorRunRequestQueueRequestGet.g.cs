...
namespace Apify
{
    public partial class DefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunRequestQueueRequestGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunRequestQueueRequestGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunRequestQueueRequestGetSecurityRequirement0,
            };
        partial void PrepareActorRunRequestQueueRequestGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string runId,
            ref string requestId);
        partial void PrepareActorRunRequestQueueRequestGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string runId,
            string requestId);
        partial void ProcessActorRunRequestQueueRequestGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunRequestQueueRequestGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.RequestResponse> ActorRunRequestQueueRequestGetAsync(
            string runId,
            string requestId,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ActorRunRequestQueueRequestGetAsResponseAsync(
                runId: runId,
                requestId: requestId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.RequestResponse>> ActorRunRequestQueueRequestGetAsResponseAsync(
            string runId,
            string requestId,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunRequestQueueRequestGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunRequestQueueRequestGetSecurityRequirements,
                operationName: "ActorRunRequestQueueRequestGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunRequestQueueRequestGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunRequestQueueRequestGet",
                                methodName: "ActorRunRequestQueueRequestGetAsync",
                                pathTemplate: "$\"/v2/actor-runs/{runId}/request-queue/requests/{requestId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunRequestQueueRequestGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunRequestQueueRequestGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
