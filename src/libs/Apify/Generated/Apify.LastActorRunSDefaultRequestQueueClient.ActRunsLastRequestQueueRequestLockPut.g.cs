...
namespace Apify
{
    public partial class LastActorRunSDefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActRunsLastRequestQueueRequestLockPutSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActRunsLastRequestQueueRequestLockPutSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActRunsLastRequestQueueRequestLockPutSecurityRequirement0,
            };
        partial void PrepareActRunsLastRequestQueueRequestLockPutArguments(
        ...
        partial void PrepareActRunsLastRequestQueueRequestLockPutRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? clientKey,
            string? forefront);
        partial void ProcessActRunsLastRequestQueueRequestLockPutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActRunsLastRequestQueueRequestLockPutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.ProlongRequestLockResponse> ActRunsLastRequestQueueRequestLockPutAsync(
            string actorId,
            string requestId,
            double lockSecs,
        ...
        {
            var __response = await ActRunsLastRequestQueueRequestLockPutAsResponseAsync(
                actorId: actorId,
                requestId: requestId,
                lockSecs: lockSecs,
                status: status,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ProlongRequestLockResponse>> ActRunsLastRequestQueueRequestLockPutAsResponseAsync(
            string actorId,
            string requestId,
            double lockSecs,
            string? status = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActRunsLastRequestQueueRequestLockPutArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActRunsLastRequestQueueRequestLockPutSecurityRequirements,
                operationName: "ActRunsLastRequestQueueRequestLockPutAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActRunsLastRequestQueueRequestLockPutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActRunsLastRequestQueueRequestLockPutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActRunsLastRequestQueueRequestLockPutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
