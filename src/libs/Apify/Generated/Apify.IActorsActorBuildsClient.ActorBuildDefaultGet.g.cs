...
namespace Apify
{
    public partial interface IActorsActorBuildsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Apify.BuildResponse> ActorBuildDefaultGetAsync(
            string actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.BuildResponse>> ActorBuildDefaultGetAsResponseAsync(
            string actorId,
            double? waitForFinish = default,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
