...
namespace Apify
{
    public partial class WebhooksWebhooksClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_WebhookWebhookDispatchesGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_WebhookWebhookDispatchesGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_WebhookWebhookDispatchesGetSecurityRequirement0,
            };
        ...
        partial void ProcessWebhookWebhookDispatchesGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebhookWebhookDispatchesGetSecurityRequirements,
                operationName: "WebhookWebhookDispatchesGetAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebhookWebhookDispatchesGet",
                                methodName: "WebhookWebhookDispatchesGetAsync",
                                pathTemplate: "$\"/v2/webhooks/{webhookId}/dispatches\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebhookWebhookDispatchesGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebhookWebhookDispatchesGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
