...
namespace Apify
{
    public sealed partial class LastActorTaskRunSDefaultKeyValueStoreClient
    {
        /// <inheritdoc cref="LastActorTaskRunSDefaultKeyValueStoreClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::Apify.EndPointAuthorization}?, bool)"/>

        public LastActorTaskRunSDefaultKeyValueStoreClient(
            string apiKey,
        ...
        /// <summary>
        /// Creates an authenticated LastActorTaskRunSDefaultKeyValueStoreClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static LastActorTaskRunSDefaultKeyValueStoreClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Apify.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            if (credentialValue is null)
            {
                throw new global::System.InvalidOperationException(
                    "No non-empty credential environment variable value was found. Checked: APIFY_API_KEY.");
            }
            ...
            var client = new LastActorTaskRunSDefaultKeyValueStoreClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated LastActorTaskRunSDefaultKeyValueStoreClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out LastActorTaskRunSDefaultKeyValueStoreClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Apify.EndPointAuthorization>? authorizations = null,
            global::Apify.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new LastActorTaskRunSDefaultKeyValueStoreClient(
                httpClient,
                baseUri,
                authorizations,
                options,
