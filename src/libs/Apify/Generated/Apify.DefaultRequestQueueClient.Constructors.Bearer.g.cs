...
namespace Apify
{
    public sealed partial class DefaultRequestQueueClient
    {
        /// <inheritdoc cref="DefaultRequestQueueClient(global::System.Net.Http.HttpClient?, global::System.Uri?, global::System.Collections.Generic.List{global::Apify.EndPointAuthorization}?, bool)"/>

        public DefaultRequestQueueClient(
            string apiKey,
        ...
        /// <summary>
        /// Creates an authenticated DefaultRequestQueueClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static DefaultRequestQueueClient CreateFromEnvironment(
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Apify.EndPointAuthorization>? authorizations = null,
            ...
            bool disposeHttpClient = true)
        {
            ...
            var client = new DefaultRequestQueueClient(
                httpClient,
                baseUri,
                authorizations,
                options,
        ...
        /// <summary>
        /// Tries to create an authenticated DefaultRequestQueueClient by resolving the configured credential environment variables.
        /// </summary>
        ...
        public static bool TryCreateFromEnvironment(
            out DefaultRequestQueueClient? client,
            global::System.Net.Http.HttpClient? httpClient = null,
            global::System.Uri? baseUri = null,
            global::System.Collections.Generic.List<global::Apify.EndPointAuthorization>? authorizations = null,
            global::Apify.AutoSDKClientOptions? options = null,
            bool disposeHttpClient = true)
        {
            ...
            client = new DefaultRequestQueueClient(
                httpClient,
                baseUri,
                authorizations,
                options,
