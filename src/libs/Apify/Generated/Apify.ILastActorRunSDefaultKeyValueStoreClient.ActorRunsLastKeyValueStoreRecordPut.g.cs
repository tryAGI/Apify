...
namespace Apify
{
    public partial interface ILastActorRunSDefaultKeyValueStoreClient
    {
        ...
        global::System.Threading.Tasks.Task<string> ActorRunsLastKeyValueStoreRecordPutAsync(
            string actorId,
            string recordKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> ActorRunsLastKeyValueStoreRecordPutAsResponseAsync(
            string actorId,
            string recordKey,
