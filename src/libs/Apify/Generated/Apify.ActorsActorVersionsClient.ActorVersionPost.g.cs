...
namespace Apify
{
    public partial class ActorsActorVersionsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorVersionPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorVersionPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorVersionPostSecurityRequirement0,
            };
        partial void PrepareActorVersionPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string actorId,
            ref string versionNumber,
            global::Apify.CreateOrUpdateVersionRequest request);
        partial void PrepareActorVersionPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string actorId,
            string versionNumber,
            global::Apify.CreateOrUpdateVersionRequest request);
        partial void ProcessActorVersionPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorVersionPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.VersionResponse> ActorVersionPostAsync(
            string actorId,
            string versionNumber,
        ...
        {
            var __response = await ActorVersionPostAsResponseAsync(
                actorId: actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.VersionResponse>> ActorVersionPostAsResponseAsync(
            string actorId,
            string versionNumber,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareActorVersionPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorVersionPostSecurityRequirements,
                operationName: "ActorVersionPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorVersionPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorVersionPost",
                                methodName: "ActorVersionPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorVersionPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorVersionPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ActorVersionPostAsync(
                actorId: actorId,
                versionNumber: versionNumber,
                request: __request,
                requestOptions: requestOptions,
