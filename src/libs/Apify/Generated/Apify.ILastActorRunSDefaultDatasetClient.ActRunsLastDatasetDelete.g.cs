...
namespace Apify
{
    public partial interface ILastActorRunSDefaultDatasetClient
    {
        ...
        global::System.Threading.Tasks.Task ActRunsLastDatasetDeleteAsync(
            string actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse> ActRunsLastDatasetDeleteAsResponseAsync(
            string actorId,
            string? status = default,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default);
