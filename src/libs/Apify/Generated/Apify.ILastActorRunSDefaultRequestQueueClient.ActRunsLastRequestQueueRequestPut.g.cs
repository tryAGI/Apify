...
namespace Apify
{
    public partial interface ILastActorRunSDefaultRequestQueueClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.UpdateRequestResponse>> ActRunsLastRequestQueueRequestPutAsResponseAsync(
            string actorId,
            string requestId,
