...
namespace Apify
{
    public partial class ActorsActorVersionsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorVersionEnvVarPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorVersionEnvVarPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorVersionEnvVarPostSecurityRequirement0,
            };
        partial void PrepareActorVersionEnvVarPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string actorId,
            ref string versionNumber,
            ref string envVarName,
            global::Apify.EnvVarRequest request);
        partial void PrepareActorVersionEnvVarPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string envVarName,
            global::Apify.EnvVarRequest request);
        partial void ProcessActorVersionEnvVarPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorVersionEnvVarPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.EnvVarResponse> ActorVersionEnvVarPostAsync(
            string actorId,
            string versionNumber,
            string envVarName,
        ...
        {
            var __response = await ActorVersionEnvVarPostAsResponseAsync(
                actorId: actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.EnvVarResponse>> ActorVersionEnvVarPostAsResponseAsync(
            string actorId,
            string versionNumber,
            string envVarName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorVersionEnvVarPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorVersionEnvVarPostSecurityRequirements,
                operationName: "ActorVersionEnvVarPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorVersionEnvVarPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorVersionEnvVarPost",
                                methodName: "ActorVersionEnvVarPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorVersionEnvVarPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorVersionEnvVarPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ActorVersionEnvVarPostAsync(
                actorId: actorId,
                versionNumber: versionNumber,
                envVarName: envVarName,
                request: __request,
