...
namespace Apify
{
    ...
    [global::System.Text.Json.Serialization.JsonSerializable(typeof(global::Apify.ActorRunRequestQueueRequestsGetFilterItem?), TypeInfoPropertyName = "NullableActorRunRequestQueueRequestsGetFilterItem2")]
    ...
    internal sealed partial class DefaultRequestQueueSourceGenerationContextChunk0 : global::System.Text.Json.Serialization.JsonSerializerContext
    {
    }
    /// <summary>
    ///
    /// </summary>
    public sealed partial class DefaultRequestQueueSourceGenerationContext : global::System.Text.Json.Serialization.JsonSerializerContext
    {
        ...
        ///
        /// </summary>
        public static DefaultRequestQueueSourceGenerationContext Default { get; } = new(DefaultOptions);

        private DefaultRequestQueueSourceGenerationContext(global::System.Text.Json.JsonSerializerOptions options)
            : base(options)
        {
        }
        ...
        private sealed class LazyEnumJsonConverterFactory : global::System.Text.Json.Serialization.JsonConverterFactory
        {
            public override bool CanConvert(global::System.Type typeToConvert)
            {
                return
                    ...
                    || typeToConvert == typeof(global::Apify.ActorRunRequestQueueRequestsGetFilterItem)
                ...
                global::System.Text.Json.JsonSerializerOptions options)
            {
                ...
                if (typeToConvert == typeof(global::Apify.ActorRunRequestQueueRequestsGetFilterItem))
                {
                    return new global::Apify.JsonConverters.ActorRunRequestQueueRequestsGetFilterItemJsonConverter();
                }

                if (typeToConvert == typeof(global::Apify.ActorRunRequestQueueRequestsGetFilterItem?))
                {
                    return new global::Apify.JsonConverters.ActorRunRequestQueueRequestsGetFilterItemNullableJsonConverter();
                }
        ...
        private sealed class LazyChunkResolver : global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver
        {
            ...
            private static global::System.Text.Json.Serialization.Metadata.IJsonTypeInfoResolver CreateResolver(int index)
            {
                return index switch
                {
                    0 => new DefaultRequestQueueSourceGenerationContextChunk0(new global::System.Text.Json.JsonSerializerOptions()),
