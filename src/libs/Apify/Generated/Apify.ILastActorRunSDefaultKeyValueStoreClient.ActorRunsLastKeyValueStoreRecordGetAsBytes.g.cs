...
namespace Apify
{
    public partial interface ILastActorRunSDefaultKeyValueStoreClient
    {
        ...
        global::System.Threading.Tasks.Task<byte[]> ActorRunsLastKeyValueStoreRecordGetAsBytesAsync(
            string actorId,
            string recordKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::System.IO.Stream> ActorRunsLastKeyValueStoreRecordGetAsBytesAsStreamAsync(
            string actorId,
            string recordKey,
            string? status = default,
            global::Apify.RunOrigin? origin = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<byte[]>> ActorRunsLastKeyValueStoreRecordGetAsBytesAsResponseAsync(
            string actorId,
            string recordKey,
            string? status = default,
            global::Apify.RunOrigin? origin = default,
