...
namespace Apify
{
    public partial interface ILastActorRunSDefaultKeyValueStoreClient
    {
        ...
        global::System.Threading.Tasks.Task ActRunsLastKeyValueStoreDeleteAsync(
            string actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse> ActRunsLastKeyValueStoreDeleteAsResponseAsync(
            string actorId,
            string? status = default,
            global::Apify.RunOrigin? origin = default,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
