...
namespace Apify
{
    public partial class ActorsActorVersionsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorVersionsPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorVersionsPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorVersionsPostSecurityRequirement0,
            };
        partial void PrepareActorVersionsPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string actorId,
            global::Apify.CreateOrUpdateVersionRequest request);
        partial void PrepareActorVersionsPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string actorId,
            global::Apify.CreateOrUpdateVersionRequest request);
        partial void ProcessActorVersionsPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorVersionsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.VersionResponse> ActorVersionsPostAsync(
            string actorId,
        ...
        {
            var __response = await ActorVersionsPostAsResponseAsync(
                actorId: actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.VersionResponse>> ActorVersionsPostAsResponseAsync(
            string actorId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareActorVersionsPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorVersionsPostSecurityRequirements,
                operationName: "ActorVersionsPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorVersionsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorVersionsPost",
                                methodName: "ActorVersionsPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorVersionsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorVersionsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ActorVersionsPostAsync(
                actorId: actorId,
                request: __request,
                requestOptions: requestOptions,
