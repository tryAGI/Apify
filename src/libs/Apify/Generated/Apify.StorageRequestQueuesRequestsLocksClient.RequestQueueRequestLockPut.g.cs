...
namespace Apify
{
    public partial class StorageRequestQueuesRequestsLocksClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_RequestQueueRequestLockPutSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_RequestQueueRequestLockPutSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_RequestQueueRequestLockPutSecurityRequirement0,
            };
        partial void PrepareRequestQueueRequestLockPutArguments(
        ...
        partial void PrepareRequestQueueRequestLockPutRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? clientKey,
            string? forefront);
        partial void ProcessRequestQueueRequestLockPutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRequestQueueRequestLockPutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.ProlongRequestLockResponse> RequestQueueRequestLockPutAsync(
            string queueId,
            string requestId,
            double lockSecs,
        ...
        {
            var __response = await RequestQueueRequestLockPutAsResponseAsync(
                queueId: queueId,
                requestId: requestId,
                lockSecs: lockSecs,
                clientKey: clientKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ProlongRequestLockResponse>> RequestQueueRequestLockPutAsResponseAsync(
            string queueId,
            string requestId,
            double lockSecs,
            string? clientKey = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRequestQueueRequestLockPutArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RequestQueueRequestLockPutSecurityRequirements,
                operationName: "RequestQueueRequestLockPutAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RequestQueueRequestLockPut",
                                methodName: "RequestQueueRequestLockPutAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRequestQueueRequestLockPutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRequestQueueRequestLockPutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
