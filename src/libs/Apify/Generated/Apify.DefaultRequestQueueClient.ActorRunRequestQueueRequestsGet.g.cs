...
namespace Apify
{
    public partial class DefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunRequestQueueRequestsGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunRequestQueueRequestsGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunRequestQueueRequestsGetSecurityRequirement0,
            };
        partial void PrepareActorRunRequestQueueRequestsGetArguments(
            ...
            ref double? limit,
            ref string? cursor,
            global::System.Collections.Generic.IList<global::Apify.ActorRunRequestQueueRequestsGetFilterItem>? filter);
        partial void PrepareActorRunRequestQueueRequestsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? cursor,
            global::System.Collections.Generic.IList<global::Apify.ActorRunRequestQueueRequestsGetFilterItem>? filter);
        partial void ProcessActorRunRequestQueueRequestsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunRequestQueueRequestsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.ListOfRequestsResponse> ActorRunRequestQueueRequestsGetAsync(
            string runId,
        ...
        {
            var __response = await ActorRunRequestQueueRequestsGetAsResponseAsync(
                runId: runId,
                clientKey: clientKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ListOfRequestsResponse>> ActorRunRequestQueueRequestsGetAsResponseAsync(
            string runId,
            string? clientKey = default,
            string? exclusiveStartId = default,
            double? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunRequestQueueRequestsGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunRequestQueueRequestsGetSecurityRequirements,
                operationName: "ActorRunRequestQueueRequestsGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunRequestQueueRequestsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunRequestQueueRequestsGet",
                                methodName: "ActorRunRequestQueueRequestsGetAsync",
                                pathTemplate: "$\"/v2/actor-runs/{runId}/request-queue/requests\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunRequestQueueRequestsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunRequestQueueRequestsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
