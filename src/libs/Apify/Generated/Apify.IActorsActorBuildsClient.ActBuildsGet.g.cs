...
namespace Apify
{
    public partial interface IActorsActorBuildsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Apify.ListOfBuildsResponse> ActBuildsGetAsync(
            string actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ListOfBuildsResponse>> ActBuildsGetAsResponseAsync(
            string actorId,
            double? offset = default,
            double? limit = default,
            bool? desc = default,
