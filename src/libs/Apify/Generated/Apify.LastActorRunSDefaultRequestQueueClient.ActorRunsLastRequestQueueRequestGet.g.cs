...
namespace Apify
{
    public partial class LastActorRunSDefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunsLastRequestQueueRequestGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunsLastRequestQueueRequestGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunsLastRequestQueueRequestGetSecurityRequirement0,
            };
        partial void PrepareActorRunsLastRequestQueueRequestGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string actorId,
            ref string? status,
            ref global::Apify.RunOrigin? origin,
            ref string requestId);
        partial void PrepareActorRunsLastRequestQueueRequestGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string requestId);
        partial void ProcessActorRunsLastRequestQueueRequestGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunsLastRequestQueueRequestGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Get request from last run's default request queue<br/>
        /// Returns a request from the default request queue of the last Actor run.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.RequestResponse> ActorRunsLastRequestQueueRequestGetAsync(
            string actorId,
            string requestId,
        ...
        {
            var __response = await ActorRunsLastRequestQueueRequestGetAsResponseAsync(
                actorId: actorId,
                requestId: requestId,
                status: status,
                origin: origin,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.RequestResponse>> ActorRunsLastRequestQueueRequestGetAsResponseAsync(
            string actorId,
            string requestId,
            string? status = default,
            global::Apify.RunOrigin? origin = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunsLastRequestQueueRequestGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunsLastRequestQueueRequestGetSecurityRequirements,
                operationName: "ActorRunsLastRequestQueueRequestGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunsLastRequestQueueRequestGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunsLastRequestQueueRequestGet",
                                methodName: "ActorRunsLastRequestQueueRequestGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunsLastRequestQueueRequestGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunsLastRequestQueueRequestGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
