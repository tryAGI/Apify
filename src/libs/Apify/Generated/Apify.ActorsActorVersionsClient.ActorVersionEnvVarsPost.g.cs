...
namespace Apify
{
    public partial class ActorsActorVersionsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorVersionEnvVarsPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorVersionEnvVarsPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorVersionEnvVarsPostSecurityRequirement0,
            };
        partial void PrepareActorVersionEnvVarsPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string actorId,
            ref string versionNumber,
            global::Apify.EnvVarRequest request);
        partial void PrepareActorVersionEnvVarsPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string actorId,
            string versionNumber,
            global::Apify.EnvVarRequest request);
        partial void ProcessActorVersionEnvVarsPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorVersionEnvVarsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.EnvVarResponse> ActorVersionEnvVarsPostAsync(
            string actorId,
            string versionNumber,
        ...
        {
            var __response = await ActorVersionEnvVarsPostAsResponseAsync(
                actorId: actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.EnvVarResponse>> ActorVersionEnvVarsPostAsResponseAsync(
            string actorId,
            string versionNumber,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorVersionEnvVarsPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorVersionEnvVarsPostSecurityRequirements,
                operationName: "ActorVersionEnvVarsPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorVersionEnvVarsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorVersionEnvVarsPost",
                                methodName: "ActorVersionEnvVarsPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorVersionEnvVarsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorVersionEnvVarsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ActorVersionEnvVarsPostAsync(
                actorId: actorId,
                versionNumber: versionNumber,
                request: __request,
                requestOptions: requestOptions,
