...
namespace Apify
{
    public partial interface ILastActorRunSDefaultDatasetClient
    {
        ...
        global::System.Threading.Tasks.Task<string> ActorRunsLastDatasetItemsGetAsTextAsync(
            string actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> ActorRunsLastDatasetItemsGetAsTextAsResponseAsync(
            string actorId,
            string? status = default,
            global::Apify.RunOrigin? origin = default,
            string? format = default,
