...
{
    /// <inheritdoc />
    public class FreeActorPricingInfoJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Apify.FreeActorPricingInfo>
    {
        /// <inheritdoc />
        public override global::Apify.FreeActorPricingInfo Read(
        ...
        public override void Write(
            ...
            global::Apify.FreeActorPricingInfo value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            if (value.IsFreeActorPricingInfoVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Apify.FreeActorPricingInfoVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Apify.FreeActorPricingInfoVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Apify.FreeActorPricingInfoVariant2).Name}");
                var __element1 = global::System.Text.Json.JsonSerializer.SerializeToElement(value.FreeActorPricingInfoVariant2!, typeInfo);
