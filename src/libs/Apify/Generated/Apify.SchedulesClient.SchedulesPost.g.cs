...
namespace Apify
{
    public partial class SchedulesClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_SchedulesPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_SchedulesPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_SchedulesPostSecurityRequirement0,
            };
        ...
        partial void ProcessSchedulesPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_SchedulesPostSecurityRequirements,
                operationName: "SchedulesPostAsync");
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessSchedulesPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await SchedulesPostAsync(
                request: __request,
                requestOptions: requestOptions,
