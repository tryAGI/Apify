...
namespace Apify
{
    public partial interface ILastActorRunSMetamorphClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Apify.RunResponse> ActRunsLastMetamorphPostAsync(
            string actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.RunResponse>> ActRunsLastMetamorphPostAsResponseAsync(
            string actorId,
            string targetActorId,
            string? status = default,
            global::Apify.RunOrigin? origin = default,
