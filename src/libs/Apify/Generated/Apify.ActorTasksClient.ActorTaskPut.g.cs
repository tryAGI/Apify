...
namespace Apify
{
    public partial class ActorTasksClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorTaskPutSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorTaskPutSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorTaskPutSecurityRequirement0,
            };
        ...
        {
            var __response = await ActorTaskPutAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ActorTaskPutResponse>> ActorTaskPutAsResponseAsync(
            string actorTaskId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorTaskPutSecurityRequirements,
                operationName: "ActorTaskPutAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorTaskPut",
                                methodName: "ActorTaskPutAsync",
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Apify.ActorTaskPutResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Apify.AutoSDKHttpResponse<global::Apify.ActorTaskPutResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Apify.ActorTaskPutResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
