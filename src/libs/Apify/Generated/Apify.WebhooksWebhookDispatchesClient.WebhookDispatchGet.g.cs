...
namespace Apify
{
    public partial class WebhooksWebhookDispatchesClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_WebhookDispatchGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_WebhookDispatchGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_WebhookDispatchGetSecurityRequirement0,
            };
        partial void PrepareWebhookDispatchGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string dispatchId);
        partial void PrepareWebhookDispatchGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string dispatchId);
        partial void ProcessWebhookDispatchGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebhookDispatchGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.WebhookDispatchResponse> WebhookDispatchGetAsync(
            string dispatchId,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await WebhookDispatchGetAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.WebhookDispatchResponse>> WebhookDispatchGetAsResponseAsync(
            string dispatchId,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebhookDispatchGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebhookDispatchGetSecurityRequirements,
                operationName: "WebhookDispatchGetAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebhookDispatchGet",
                                methodName: "WebhookDispatchGetAsync",
                                pathTemplate: "$\"/v2/webhook-dispatches/{dispatchId}\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebhookDispatchGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebhookDispatchGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
