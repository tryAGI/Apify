...
namespace Apify
{
    public partial class WebhooksWebhookDispatchesClient
    {


        private static readonly global::Apify.EndPointSecurityRequirement s_WebhookDispatchesGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_WebhookDispatchesGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_WebhookDispatchesGetSecurityRequirement0,
            };
        partial void PrepareWebhookDispatchesGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref double? offset,
            ref double? limit,
            ref bool? desc);
        partial void PrepareWebhookDispatchesGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            double? offset,
            double? limit,
            bool? desc);
        partial void ProcessWebhookDispatchesGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessWebhookDispatchesGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await WebhookDispatchesGetAsResponseAsync(
                offset: offset,
                limit: limit,
                desc: desc,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ListOfWebhookDispatchesResponse>> WebhookDispatchesGetAsResponseAsync(
            double? offset = default,
            double? limit = default,
            bool? desc = default,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareWebhookDispatchesGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_WebhookDispatchesGetSecurityRequirements,
                operationName: "WebhookDispatchesGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareWebhookDispatchesGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "WebhookDispatchesGet",
                                methodName: "WebhookDispatchesGetAsync",
                                pathTemplate: "\"/v2/webhook-dispatches\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessWebhookDispatchesGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessWebhookDispatchesGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Apify.ListOfWebhookDispatchesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Apify.AutoSDKHttpResponse<global::Apify.ListOfWebhookDispatchesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Apify.ListOfWebhookDispatchesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
