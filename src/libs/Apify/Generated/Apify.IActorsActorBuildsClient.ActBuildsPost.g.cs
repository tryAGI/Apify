...
namespace Apify
{
    public partial interface IActorsActorBuildsClient
    {
        ...
        global::System.Threading.Tasks.Task<global::Apify.BuildResponse> ActBuildsPostAsync(
            string actorId,
            string version,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.BuildResponse>> ActBuildsPostAsResponseAsync(
            string actorId,
            string version,
            bool? useCache = default,
            bool? betaPackages = default,
