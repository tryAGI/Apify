...
namespace Apify
{
    public partial class StorageRequestQueuesClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_RequestQueueRequestsBatchDeleteSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_RequestQueueRequestsBatchDeleteSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_RequestQueueRequestsBatchDeleteSecurityRequirement0,
            };
        ...
        partial void ProcessRequestQueueRequestsBatchDeleteResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await RequestQueueRequestsBatchDeleteAsResponseAsync(
                queueId: queueId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareRequestQueueRequestsBatchDeleteArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RequestQueueRequestsBatchDeleteSecurityRequirements,
                operationName: "RequestQueueRequestsBatchDeleteAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRequestQueueRequestsBatchDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RequestQueueRequestsBatchDelete",
                                methodName: "RequestQueueRequestsBatchDeleteAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRequestQueueRequestsBatchDeleteResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRequestQueueRequestsBatchDeleteResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
