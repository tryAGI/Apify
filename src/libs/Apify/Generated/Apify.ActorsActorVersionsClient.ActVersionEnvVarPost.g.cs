...
namespace Apify
{
    public partial class ActorsActorVersionsClient
    {


        private static readonly global::Apify.EndPointSecurityRequirement s_ActVersionEnvVarPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActVersionEnvVarPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActVersionEnvVarPostSecurityRequirement0,
            };
        partial void PrepareActVersionEnvVarPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string actorId,
            ref string versionNumber,
            ref string envVarName,
            global::Apify.EnvVarRequest request);
        partial void PrepareActVersionEnvVarPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string envVarName,
            global::Apify.EnvVarRequest request);
        partial void ProcessActVersionEnvVarPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActVersionEnvVarPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.EnvVarResponse> ActVersionEnvVarPostAsync(
            string actorId,
            string versionNumber,
            string envVarName,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActVersionEnvVarPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActVersionEnvVarPostSecurityRequirements,
                operationName: "ActVersionEnvVarPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActVersionEnvVarPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActVersionEnvVarPost",
                                methodName: "ActVersionEnvVarPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActVersionEnvVarPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 404)
                            {
                                ...
                                global::Apify.OneOf<global::Apify.ActorNotFoundError, global::Apify.ActorVersionNotFoundError, global::Apify.EnvironmentVariableNotFoundError>? __value_404 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_404 = global::Apify.OneOf<global::Apify.ActorNotFoundError, global::Apify.ActorVersionNotFoundError, global::Apify.EnvironmentVariableNotFoundError>.FromJson(__content_404, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_404 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                ...
                                throw new global::Apify.ApiException<global::Apify.OneOf<global::Apify.ActorNotFoundError, global::Apify.ActorVersionNotFoundError, global::Apify.EnvironmentVariableNotFoundError>?>(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActVersionEnvVarPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ActVersionEnvVarPostAsync(
                actorId: actorId,
                versionNumber: versionNumber,
                envVarName: envVarName,
                request: __request,
