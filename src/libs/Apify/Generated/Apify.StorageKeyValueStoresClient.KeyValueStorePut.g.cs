...
namespace Apify
{
    public partial class StorageKeyValueStoresClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_KeyValueStorePutSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_KeyValueStorePutSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_KeyValueStorePutSecurityRequirement0,
            };
        ...
        partial void ProcessKeyValueStorePutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareKeyValueStorePutArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_KeyValueStorePutSecurityRequirements,
                operationName: "KeyValueStorePutAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareKeyValueStorePutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "KeyValueStorePut",
                                methodName: "KeyValueStorePutAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessKeyValueStorePutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessKeyValueStorePutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await KeyValueStorePutAsync(
                storeId: storeId,
                request: __request,
                requestOptions: requestOptions,
