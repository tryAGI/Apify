...
namespace Apify
{
    public partial class DefaultKeyValueStoreClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunKeyValueStoreRecordPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunKeyValueStoreRecordPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunKeyValueStoreRecordPostSecurityRequirement0,
            };
        partial void PrepareActorRunKeyValueStoreRecordPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string runId,
            ref string recordKey,
            ref global::Apify.ActorRunKeyValueStoreRecordPostContentEncoding? contentEncoding,
            global::Apify.PutRecordRequest request);
        partial void PrepareActorRunKeyValueStoreRecordPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string runId,
            string recordKey,
            global::Apify.ActorRunKeyValueStoreRecordPostContentEncoding? contentEncoding,
            global::Apify.PutRecordRequest request);
        partial void ProcessActorRunKeyValueStoreRecordPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunKeyValueStoreRecordPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ActorRunKeyValueStoreRecordPostAsync(
            string runId,
            string recordKey,
        ...
        {
            var __response = await ActorRunKeyValueStoreRecordPostAsResponseAsync(
                runId: runId,
                recordKey: recordKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> ActorRunKeyValueStoreRecordPostAsResponseAsync(
            string runId,
            string recordKey,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunKeyValueStoreRecordPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunKeyValueStoreRecordPostSecurityRequirements,
                operationName: "ActorRunKeyValueStoreRecordPostAsync");
            ...
            if (contentEncoding != default)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunKeyValueStoreRecordPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunKeyValueStoreRecordPost",
                                methodName: "ActorRunKeyValueStoreRecordPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunKeyValueStoreRecordPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunKeyValueStoreRecordPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ActorRunKeyValueStoreRecordPostAsync(
                runId: runId,
                recordKey: recordKey,
                contentEncoding: contentEncoding,
                request: __request,
