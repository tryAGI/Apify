...
namespace Apify
{
    public partial class LastActorTaskRunSDefaultKeyValueStoreClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorTaskRunsLastKeyValueStorePutSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorTaskRunsLastKeyValueStorePutSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorTaskRunsLastKeyValueStorePutSecurityRequirement0,
            };
        partial void PrepareActorTaskRunsLastKeyValueStorePutArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string actorTaskId,
            ref string? status,
            global::Apify.UpdateStoreRequest request);
        partial void PrepareActorTaskRunsLastKeyValueStorePutRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string actorTaskId,
            string? status,
            global::Apify.UpdateStoreRequest request);
        partial void ProcessActorTaskRunsLastKeyValueStorePutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorTaskRunsLastKeyValueStorePutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Update last task run's default store<br/>
        /// Updates the default key-value store associated with the last Actor task run.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.KeyValueStoreResponse> ActorTaskRunsLastKeyValueStorePutAsync(
            string actorTaskId,
        ...
        {
            var __response = await ActorTaskRunsLastKeyValueStorePutAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.KeyValueStoreResponse>> ActorTaskRunsLastKeyValueStorePutAsResponseAsync(
            string actorTaskId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareActorTaskRunsLastKeyValueStorePutArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorTaskRunsLastKeyValueStorePutSecurityRequirements,
                operationName: "ActorTaskRunsLastKeyValueStorePutAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorTaskRunsLastKeyValueStorePutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorTaskRunsLastKeyValueStorePut",
                                methodName: "ActorTaskRunsLastKeyValueStorePutAsync",
                                pathTemplate: "$\"/v2/actor-tasks/{actorTaskId}/runs/last/key-value-store\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorTaskRunsLastKeyValueStorePutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorTaskRunsLastKeyValueStorePutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ActorTaskRunsLastKeyValueStorePutAsync(
                actorTaskId: actorTaskId,
                status: status,
                request: __request,
                requestOptions: requestOptions,
