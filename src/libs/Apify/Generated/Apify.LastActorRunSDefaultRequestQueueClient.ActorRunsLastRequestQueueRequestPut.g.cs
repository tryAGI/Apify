...
namespace Apify
{
    public partial class LastActorRunSDefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunsLastRequestQueueRequestPutSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunsLastRequestQueueRequestPutSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunsLastRequestQueueRequestPutSecurityRequirement0,
            };
        partial void PrepareActorRunsLastRequestQueueRequestPutArguments(
        ...
        partial void PrepareActorRunsLastRequestQueueRequestPutRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? clientKey,
            global::Apify.RequestWithoutId request);
        partial void ProcessActorRunsLastRequestQueueRequestPutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunsLastRequestQueueRequestPutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.UpdateRequestResponse> ActorRunsLastRequestQueueRequestPutAsync(
            string actorId,
            string requestId,
        ...
        {
            var __response = await ActorRunsLastRequestQueueRequestPutAsResponseAsync(
                actorId: actorId,
                requestId: requestId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.UpdateRequestResponse>> ActorRunsLastRequestQueueRequestPutAsResponseAsync(
            string actorId,
            string requestId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunsLastRequestQueueRequestPutArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunsLastRequestQueueRequestPutSecurityRequirements,
                operationName: "ActorRunsLastRequestQueueRequestPutAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunsLastRequestQueueRequestPutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunsLastRequestQueueRequestPut",
                                methodName: "ActorRunsLastRequestQueueRequestPutAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunsLastRequestQueueRequestPutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunsLastRequestQueueRequestPutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ActorRunsLastRequestQueueRequestPutAsync(
                actorId: actorId,
                status: status,
                origin: origin,
                requestId: requestId,
