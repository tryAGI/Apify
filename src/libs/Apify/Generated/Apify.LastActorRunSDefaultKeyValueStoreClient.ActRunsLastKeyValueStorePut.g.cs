...
namespace Apify
{
    public partial class LastActorRunSDefaultKeyValueStoreClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActRunsLastKeyValueStorePutSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActRunsLastKeyValueStorePutSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActRunsLastKeyValueStorePutSecurityRequirement0,
            };
        partial void PrepareActRunsLastKeyValueStorePutArguments(
        ...
        partial void ProcessActRunsLastKeyValueStorePutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await ActRunsLastKeyValueStorePutAsResponseAsync(
                actorId: actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.KeyValueStoreResponse>> ActRunsLastKeyValueStorePutAsResponseAsync(
            string actorId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareActRunsLastKeyValueStorePutArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActRunsLastKeyValueStorePutSecurityRequirements,
                operationName: "ActRunsLastKeyValueStorePutAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActRunsLastKeyValueStorePut",
                                methodName: "ActRunsLastKeyValueStorePutAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActRunsLastKeyValueStorePutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActRunsLastKeyValueStorePutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
