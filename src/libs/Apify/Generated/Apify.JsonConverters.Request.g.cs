...
{
    /// <inheritdoc />
    public class RequestJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Apify.Request>
    {
        /// <inheritdoc />
        public override global::Apify.Request Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            var __score0 = 0;
            if (__jsonProps.Contains("errorMessages")) __score0++;
            if (__jsonProps.Contains("handledAt")) __score0++;
            if (__jsonProps.Contains("headers")) __score0++;
            if (__jsonProps.Contains("loadedUrl")) __score0++;
            if (__jsonProps.Contains("method")) __score0++;
            if (__jsonProps.Contains("noRetry")) __score0++;
            if (__jsonProps.Contains("payload")) __score0++;
            if (__jsonProps.Contains("retryCount")) __score0++;
            ...
            global::Apify.RequestBase? requestBase = default;
            global::Apify.RequestVariant2? requestVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
            ...
            var __value = new global::Apify.Request(
                requestBase,
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            else if (value.IsRequestVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Apify.RequestVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Apify.RequestVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Apify.RequestVariant2).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.RequestVariant2!, typeInfo);
            }
        }
    }
}