...
namespace Apify
{
    public partial class ActorBuildsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorBuildAbortPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorBuildAbortPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorBuildAbortPostSecurityRequirement0,
            };
        partial void PrepareActorBuildAbortPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string buildId);
        partial void PrepareActorBuildAbortPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string buildId);
        partial void ProcessActorBuildAbortPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorBuildAbortPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.BuildResponse> ActorBuildAbortPostAsync(
            string buildId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorBuildAbortPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorBuildAbortPostSecurityRequirements,
                operationName: "ActorBuildAbortPostAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorBuildAbortPost",
                                methodName: "ActorBuildAbortPostAsync",
                                pathTemplate: "$\"/v2/actor-builds/{buildId}/abort\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorBuildAbortPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorBuildAbortPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
