...
namespace Apify
{
    public partial class ActorsActorRunsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunSyncGetDatasetItemsGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunSyncGetDatasetItemsGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunSyncGetDatasetItemsGetSecurityRequirement0,
            };
        partial void PrepareActorRunSyncGetDatasetItemsGetArguments(
        ...
        partial void PrepareActorRunSyncGetDatasetItemsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessActorRunSyncGetDatasetItemsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunSyncGetDatasetItemsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// Run Actor synchronously without input and get dataset items<br/>
        ...
        /// It allows to send all possible options in parameters from [Get Dataset<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::System.Collections.Generic.IList<object>> ActorRunSyncGetDatasetItemsGetAsync(
            string actorId,
        ...
        {
            var __response = await ActorRunSyncGetDatasetItemsGetAsResponseAsync(
                actorId: actorId,
                timeout: timeout,
                memory: memory,
                maxItems: maxItems,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::System.Collections.Generic.IList<object>>> ActorRunSyncGetDatasetItemsGetAsResponseAsync(
            string actorId,
            double? timeout = default,
            double? memory = default,
            double? maxItems = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunSyncGetDatasetItemsGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunSyncGetDatasetItemsGetSecurityRequirements,
                operationName: "ActorRunSyncGetDatasetItemsGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunSyncGetDatasetItemsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunSyncGetDatasetItemsGet",
                                methodName: "ActorRunSyncGetDatasetItemsGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunSyncGetDatasetItemsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunSyncGetDatasetItemsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
