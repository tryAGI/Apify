...
namespace Apify
{
    public partial class StorageDatasetsClient
    {
        ...
        {
            var __response = await DatasetGetAsResponseAsync(
                datasetId: datasetId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.DatasetResponse>> DatasetGetAsResponseAsync(
            string datasetId,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
