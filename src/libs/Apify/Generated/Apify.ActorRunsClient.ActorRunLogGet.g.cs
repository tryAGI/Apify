...
namespace Apify
{
    public partial class ActorRunsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunLogGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunLogGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunLogGetSecurityRequirement0,
            };
        partial void PrepareActorRunLogGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string runId,
            ref bool? stream,
            ref bool? download,
            ref bool? raw);
        partial void PrepareActorRunLogGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? download,
            bool? raw);
        partial void ProcessActorRunLogGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunLogGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ActorRunLogGetAsync(
            string runId,
            bool? stream = default,
        ...
        {
            var __response = await ActorRunLogGetAsResponseAsync(
                runId: runId,
                stream: stream,
                download: download,
                raw: raw,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> ActorRunLogGetAsResponseAsync(
            string runId,
            bool? stream = default,
            bool? download = default,
            bool? raw = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunLogGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunLogGetSecurityRequirements,
                operationName: "ActorRunLogGetAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunLogGet",
                                methodName: "ActorRunLogGetAsync",
                                pathTemplate: "$\"/v2/actor-runs/{runId}/log\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunLogGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
