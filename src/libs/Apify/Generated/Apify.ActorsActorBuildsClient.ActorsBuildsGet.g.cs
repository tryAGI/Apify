...
namespace Apify
{
    public partial class ActorsActorBuildsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorsBuildsGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorsBuildsGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorsBuildsGetSecurityRequirement0,
            };
        partial void PrepareActorsBuildsGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string actorId,
            ref double? offset,
            ref double? limit,
            ref bool? desc);
        partial void PrepareActorsBuildsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            double? limit,
            bool? desc);
        partial void ProcessActorsBuildsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorsBuildsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.ListOfBuildsResponse> ActorsBuildsGetAsync(
            string actorId,
        ...
        {
            var __response = await ActorsBuildsGetAsResponseAsync(
                actorId: actorId,
                offset: offset,
                limit: limit,
                desc: desc,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ListOfBuildsResponse>> ActorsBuildsGetAsResponseAsync(
            string actorId,
            double? offset = default,
            double? limit = default,
            bool? desc = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorsBuildsGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorsBuildsGetSecurityRequirements,
                operationName: "ActorsBuildsGetAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorsBuildsGet",
                                methodName: "ActorsBuildsGetAsync",
                                pathTemplate: "$\"/v2/actors/{actorId}/builds\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorsBuildsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorsBuildsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Apify.ListOfBuildsResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Apify.AutoSDKHttpResponse<global::Apify.ListOfBuildsResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Apify.ListOfBuildsResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
