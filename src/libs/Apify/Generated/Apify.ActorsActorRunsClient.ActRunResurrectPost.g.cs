...
namespace Apify
{
    public partial class ActorsActorRunsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActRunResurrectPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActRunResurrectPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActRunResurrectPostSecurityRequirement0,
            };
        partial void PrepareActRunResurrectPostArguments(
        ...
        partial void PrepareActRunResurrectPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            double? memory,
            bool? restartOnError);
        partial void ProcessActRunResurrectPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActRunResurrectPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.RunResponse> ActRunResurrectPostAsync(
            string actorId,
            string runId,
        ...
        {
            var __response = await ActRunResurrectPostAsResponseAsync(
                actorId: actorId,
                runId: runId,
                build: build,
                timeout: timeout,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.RunResponse>> ActRunResurrectPostAsResponseAsync(
            string actorId,
            string runId,
            string? build = default,
            double? timeout = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActRunResurrectPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActRunResurrectPostSecurityRequirements,
                operationName: "ActRunResurrectPostAsync");
            ...
            try
            {
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActRunResurrectPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActRunResurrectPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
