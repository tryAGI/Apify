...
namespace Apify
{
    public partial interface IActorTasksClient
    {
        ...
        global::System.Threading.Tasks.Task<string> ActorTaskRunSyncGetDatasetItemsGetAsync(
            string actorTaskId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> ActorTaskRunSyncGetDatasetItemsGetAsResponseAsync(
            string actorTaskId,
            double? timeout = default,
            double? memory = default,
            double? maxItems = default,
