...
namespace Apify
{
    public partial class LastActorRunSDefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActRunsLastRequestQueueRequestPutSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActRunsLastRequestQueueRequestPutSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActRunsLastRequestQueueRequestPutSecurityRequirement0,
            };
        partial void PrepareActRunsLastRequestQueueRequestPutArguments(
        ...
        partial void PrepareActRunsLastRequestQueueRequestPutRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? clientKey,
            global::Apify.Request request);
        partial void ProcessActRunsLastRequestQueueRequestPutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActRunsLastRequestQueueRequestPutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.UpdateRequestResponse> ActRunsLastRequestQueueRequestPutAsync(
            string actorId,
            string requestId,
        ...
        {
            var __response = await ActRunsLastRequestQueueRequestPutAsResponseAsync(
                actorId: actorId,
                requestId: requestId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.UpdateRequestResponse>> ActRunsLastRequestQueueRequestPutAsResponseAsync(
            string actorId,
            string requestId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActRunsLastRequestQueueRequestPutArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActRunsLastRequestQueueRequestPutSecurityRequirements,
                operationName: "ActRunsLastRequestQueueRequestPutAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActRunsLastRequestQueueRequestPutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActRunsLastRequestQueueRequestPut",
                                methodName: "ActRunsLastRequestQueueRequestPutAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActRunsLastRequestQueueRequestPutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActRunsLastRequestQueueRequestPutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            return await ActRunsLastRequestQueueRequestPutAsync(
                actorId: actorId,
                status: status,
                requestId: requestId,
                forefront: forefront,
