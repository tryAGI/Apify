...
namespace Apify
{
    ...
    public sealed partial class ApifyClient : global::Apify.IApifyClient, global::System.IDisposable
    {
        ...
        /// </summary>
        public ToolsEncodingClient ToolsEncoding => new ToolsEncodingClient(HttpClient, baseUri: null, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            CreateIdempotencyKey = CreateIdempotencyKey,
            JsonSerializerContextProvider = JsonSerializerContextProvider,
        ...
        /// </summary>
        public UsersUsageClient UsersUsage => new UsersUsageClient(HttpClient, baseUri: null, authorizations: Authorizations, options: Options)
        {
            ReadResponseAsString = ReadResponseAsString,
            CreateIdempotencyKey = CreateIdempotencyKey,
            JsonSerializerContextProvider = JsonSerializerContextProvider,
