...
namespace Apify
{
    public partial class ActorBuildsClient
    {
        ...
        {
            var __response = await ActorBuildLogGetAsResponseAsync(
                buildId: buildId,
                stream: stream,
                download: download,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> ActorBuildLogGetAsResponseAsync(
            string buildId,
            bool? stream = default,
            bool? download = default,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
