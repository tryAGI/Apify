...
namespace Apify
{
    public partial class LastActorRunSRebootClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunsLastRebootPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunsLastRebootPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunsLastRebootPostSecurityRequirement0,
            };
        partial void PrepareActorRunsLastRebootPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string actorId,
            ref string? status,
            ref global::Apify.RunOrigin? origin);
        partial void PrepareActorRunsLastRebootPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string actorId,
            string? status,
            global::Apify.RunOrigin? origin);
        partial void ProcessActorRunsLastRebootPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunsLastRebootPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.RunResponse> ActorRunsLastRebootPostAsync(
            string actorId,
        ...
        {
            var __response = await ActorRunsLastRebootPostAsResponseAsync(
                actorId: actorId,
                status: status,
                origin: origin,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.RunResponse>> ActorRunsLastRebootPostAsResponseAsync(
            string actorId,
            string? status = default,
            global::Apify.RunOrigin? origin = default,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunsLastRebootPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunsLastRebootPostSecurityRequirements,
                operationName: "ActorRunsLastRebootPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunsLastRebootPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunsLastRebootPost",
                                methodName: "ActorRunsLastRebootPostAsync",
                                pathTemplate: "$\"/v2/actors/{actorId}/runs/last/reboot\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunsLastRebootPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunsLastRebootPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
