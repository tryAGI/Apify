...
namespace Apify
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Apify.AutoSDKRetryOptions Retry { get; set; } = new global::Apify.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Apify.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Apify.IAutoSDKHook>();
        ...
        public global::Apify.AutoSDKClientOptions AddHook(
            global::Apify.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Apify.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Apify.AutoSDKClientOptions UseAuthorizationProvider(
            global::Apify.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Apify.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Apify.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Apify.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Apify.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Apify.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Apify.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Apify.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Apify.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Apify.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Apify.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Apify.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Apify.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Apify.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Apify.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Apify.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Apify.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Apify.AutoSDKClientOptions clientOptions,
            global::Apify.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Apify.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Apify.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Apify.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Apify.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Apify.IAutoSDKHook, global::Apify.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Apify.AutoSDKHookContext context)
        {
