...
namespace Apify
{
    public partial class StorageKeyValueStoresClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_KeyValueStoresPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_KeyValueStoresPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_KeyValueStoresPostSecurityRequirement0,
            };
        partial void PrepareKeyValueStoresPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string? name);
        partial void PrepareKeyValueStoresPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string? name);
        partial void ProcessKeyValueStoresPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessKeyValueStoresPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.KeyValueStoreResponse> KeyValueStoresPostAsync(
            string? name = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_KeyValueStoresPostSecurityRequirements,
                operationName: "KeyValueStoresPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareKeyValueStoresPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "KeyValueStoresPost",
                                methodName: "KeyValueStoresPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessKeyValueStoresPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessKeyValueStoresPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
