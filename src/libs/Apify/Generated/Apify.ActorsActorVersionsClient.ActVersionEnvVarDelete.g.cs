...
namespace Apify
{
    public partial class ActorsActorVersionsClient
    {
        ...
        {
            var __response = await ActVersionEnvVarDeleteAsResponseAsync(
                actorId: actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> ActVersionEnvVarDeleteAsResponseAsync(
            string actorId,
            string versionNumber,
            string envVarName,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
