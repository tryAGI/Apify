...
namespace Apify
{
    public partial class StorageKeyValueStoresClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_KeyValueStoreKeysGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_KeyValueStoreKeysGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_KeyValueStoreKeysGetSecurityRequirement0,
            };
        partial void PrepareKeyValueStoreKeysGetArguments(
        ...
        partial void PrepareKeyValueStoreKeysGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? prefix,
            string? signature);
        partial void ProcessKeyValueStoreKeysGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessKeyValueStoreKeysGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.ListOfKeysResponse> KeyValueStoreKeysGetAsync(
            string storeId,
        ...
        {
            var __response = await KeyValueStoreKeysGetAsResponseAsync(
                storeId: storeId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ListOfKeysResponse>> KeyValueStoreKeysGetAsResponseAsync(
            string storeId,
            string? exclusiveStartKey = default,
            double? limit = default,
            string? collection = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareKeyValueStoreKeysGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_KeyValueStoreKeysGetSecurityRequirements,
                operationName: "KeyValueStoreKeysGetAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "KeyValueStoreKeysGet",
                                methodName: "KeyValueStoreKeysGetAsync",
                                pathTemplate: "$\"/v2/key-value-stores/{storeId}/keys\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessKeyValueStoreKeysGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessKeyValueStoreKeysGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
