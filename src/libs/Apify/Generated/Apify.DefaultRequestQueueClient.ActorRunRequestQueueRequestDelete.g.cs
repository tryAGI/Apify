...
namespace Apify
{
    public partial class DefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunRequestQueueRequestDeleteSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunRequestQueueRequestDeleteSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunRequestQueueRequestDeleteSecurityRequirement0,
            };
        partial void PrepareActorRunRequestQueueRequestDeleteArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string runId,
            ref string requestId,
            ref string? clientKey);
        partial void PrepareActorRunRequestQueueRequestDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string runId,
            string requestId,
            string? clientKey);
        partial void ProcessActorRunRequestQueueRequestDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        /// <summary>
        /// Delete request from default request queue<br/>
        /// Deletes a request from the default request queue of the Actor run.<br/>
        ...
        public async global::System.Threading.Tasks.Task ActorRunRequestQueueRequestDeleteAsync(
            string runId,
            string requestId,
        ...
        {
            await ActorRunRequestQueueRequestDeleteAsResponseAsync(
                runId: runId,
                requestId: requestId,
                clientKey: clientKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse> ActorRunRequestQueueRequestDeleteAsResponseAsync(
            string runId,
            string requestId,
            string? clientKey = default,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunRequestQueueRequestDeleteArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunRequestQueueRequestDeleteSecurityRequirements,
                operationName: "ActorRunRequestQueueRequestDeleteAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunRequestQueueRequestDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunRequestQueueRequestDelete",
                                methodName: "ActorRunRequestQueueRequestDeleteAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunRequestQueueRequestDeleteResponse(
                    httpClient: HttpClient,
