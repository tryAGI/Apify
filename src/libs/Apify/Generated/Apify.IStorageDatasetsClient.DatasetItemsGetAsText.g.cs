...
namespace Apify
{
    public partial interface IStorageDatasetsClient
    {
        ...
        global::System.Threading.Tasks.Task<string> DatasetItemsGetAsTextAsync(
            string datasetId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> DatasetItemsGetAsTextAsResponseAsync(
            string datasetId,
            string? format = default,
            bool? clean = default,
            double? offset = default,
