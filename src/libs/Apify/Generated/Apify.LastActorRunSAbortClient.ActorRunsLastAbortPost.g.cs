...
namespace Apify
{
    public partial class LastActorRunSAbortClient
    {


        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunsLastAbortPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunsLastAbortPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunsLastAbortPostSecurityRequirement0,
            };
        partial void PrepareActorRunsLastAbortPostArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string actorId,
            ref string? status,
            ref global::Apify.RunOrigin? origin,
            ref bool? gracefully);
        partial void PrepareActorRunsLastAbortPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            bool? gracefully);
        partial void ProcessActorRunsLastAbortPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunsLastAbortPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.RunResponse> ActorRunsLastAbortPostAsync(
            string actorId,
        ...
        {
            var __response = await ActorRunsLastAbortPostAsResponseAsync(
                actorId: actorId,
                status: status,
                origin: origin,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.RunResponse>> ActorRunsLastAbortPostAsResponseAsync(
            string actorId,
            string? status = default,
            global::Apify.RunOrigin? origin = default,
            bool? gracefully = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunsLastAbortPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunsLastAbortPostSecurityRequirements,
                operationName: "ActorRunsLastAbortPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunsLastAbortPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunsLastAbortPost",
                                methodName: "ActorRunsLastAbortPostAsync",
                                pathTemplate: "$\"/v2/actors/{actorId}/runs/last/abort\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunsLastAbortPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunsLastAbortPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
