...
namespace Apify
{
    public partial class StorageRequestQueuesRequestsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_RequestQueueRequestPutSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_RequestQueueRequestPutSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_RequestQueueRequestPutSecurityRequirement0,
            };
        partial void PrepareRequestQueueRequestPutArguments(
        ...
        partial void ProcessRequestQueueRequestPutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        {
            var __response = await RequestQueueRequestPutAsResponseAsync(
                queueId: queueId,
                requestId: requestId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.UpdateRequestResponse>> RequestQueueRequestPutAsResponseAsync(
            string queueId,
            string requestId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RequestQueueRequestPutSecurityRequirements,
                operationName: "RequestQueueRequestPutAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareRequestQueueRequestPutRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RequestQueueRequestPut",
                                methodName: "RequestQueueRequestPutAsync",
                                pathTemplate: "$\"/v2/request-queues/{queueId}/requests/{requestId}\"",
                                httpMethod: "PUT",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRequestQueueRequestPutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRequestQueueRequestPutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
