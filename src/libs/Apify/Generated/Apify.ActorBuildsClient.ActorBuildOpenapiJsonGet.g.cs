...
namespace Apify
{
    public partial class ActorBuildsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorBuildOpenapiJsonGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorBuildOpenapiJsonGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorBuildOpenapiJsonGetSecurityRequirement0,
            };
        partial void PrepareActorBuildOpenapiJsonGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string buildId);
        partial void PrepareActorBuildOpenapiJsonGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string buildId);
        partial void ProcessActorBuildOpenapiJsonGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorBuildOpenapiJsonGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// - [First endpoint](/api/v2/act-openapi-json-get): Requires both `actorId` and `buildId`. Use `default` as the `buildId` to get the OpenAPI schema for the default Actor build.<br/>
        ...
        /// :::note<br/>
        /// You can also use the [`/api/v2/act-openapi-json-get`](/api/v2/act-openapi-json-get) endpoint to get the OpenAPI definition for a build.<br/>
        /// :::
        /// </summary>
        /// <param name="buildId">
        ...
        public async global::System.Threading.Tasks.Task<string> ActorBuildOpenapiJsonGetAsync(
            string buildId,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await ActorBuildOpenapiJsonGetAsResponseAsync(
                buildId: buildId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> ActorBuildOpenapiJsonGetAsResponseAsync(
            string buildId,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorBuildOpenapiJsonGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorBuildOpenapiJsonGetSecurityRequirements,
                operationName: "ActorBuildOpenapiJsonGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorBuildOpenapiJsonGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorBuildOpenapiJsonGet",
                                methodName: "ActorBuildOpenapiJsonGetAsync",
                                pathTemplate: "$\"/v2/actor-builds/{buildId}/openapi.json\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorBuildOpenapiJsonGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorBuildOpenapiJsonGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
