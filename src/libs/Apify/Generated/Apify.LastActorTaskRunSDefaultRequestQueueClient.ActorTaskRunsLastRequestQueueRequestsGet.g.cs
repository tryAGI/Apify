...
namespace Apify
{
    public partial class LastActorTaskRunSDefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorTaskRunsLastRequestQueueRequestsGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorTaskRunsLastRequestQueueRequestsGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorTaskRunsLastRequestQueueRequestsGetSecurityRequirement0,
            };
        partial void PrepareActorTaskRunsLastRequestQueueRequestsGetArguments(
            ...
            ref double? limit,
            ref string? cursor,
            global::System.Collections.Generic.IList<global::Apify.ActorTaskRunsLastRequestQueueRequestsGetFilterItem>? filter);
        partial void PrepareActorTaskRunsLastRequestQueueRequestsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? cursor,
            global::System.Collections.Generic.IList<global::Apify.ActorTaskRunsLastRequestQueueRequestsGetFilterItem>? filter);
        partial void ProcessActorTaskRunsLastRequestQueueRequestsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorTaskRunsLastRequestQueueRequestsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);

        /// <summary>
        /// List last task run's default request queue's requests<br/>
        /// Returns a list of requests from the default request queue of the last Actor task run.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.ListOfRequestsResponse> ActorTaskRunsLastRequestQueueRequestsGetAsync(
            ...
            global::System.Collections.Generic.IList<global::Apify.ActorTaskRunsLastRequestQueueRequestsGetFilterItem>? filter = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorTaskRunsLastRequestQueueRequestsGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorTaskRunsLastRequestQueueRequestsGetSecurityRequirements,
                operationName: "ActorTaskRunsLastRequestQueueRequestsGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorTaskRunsLastRequestQueueRequestsGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorTaskRunsLastRequestQueueRequestsGet",
                                methodName: "ActorTaskRunsLastRequestQueueRequestsGetAsync",
                                pathTemplate: "$\"/v2/actor-tasks/{actorTaskId}/runs/last/request-queue/requests\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorTaskRunsLastRequestQueueRequestsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorTaskRunsLastRequestQueueRequestsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
