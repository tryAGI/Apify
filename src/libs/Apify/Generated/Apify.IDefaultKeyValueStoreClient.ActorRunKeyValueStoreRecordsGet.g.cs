...
namespace Apify
{
    public partial interface IDefaultKeyValueStoreClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::System.IO.Stream> ActorRunKeyValueStoreRecordsGetAsStreamAsync(
            string runId,
            string? collection = default,
            string? prefix = default,
            string? signature = default,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<byte[]>> ActorRunKeyValueStoreRecordsGetAsResponseAsync(
            string runId,
            string? collection = default,
            string? prefix = default,
            string? signature = default,
