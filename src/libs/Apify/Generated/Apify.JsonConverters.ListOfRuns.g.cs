...
{
    /// <inheritdoc />
    public class ListOfRunsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Apify.ListOfRuns>
    {
        /// <inheritdoc />
        public override global::Apify.ListOfRuns Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Apify.ListOfRunsVariant2? listOfRunsVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        listOfRunsVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (paginationResponse == null && listOfRunsVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::Apify.ListOfRuns(
                paginationResponse,
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            else if (value.IsListOfRunsVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Apify.ListOfRunsVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Apify.ListOfRunsVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Apify.ListOfRunsVariant2).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.ListOfRunsVariant2!, typeInfo);
            }
        }
    }
}