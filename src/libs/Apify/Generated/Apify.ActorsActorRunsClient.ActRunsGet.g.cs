...
namespace Apify
{
    public partial class ActorsActorRunsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActRunsGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActRunsGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActRunsGetSecurityRequirement0,
            };
        partial void PrepareActRunsGetArguments(
        ...
        partial void ProcessActRunsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.ListOfRunsResponse> ActRunsGetAsync(
            string actorId,
        ...
        {
            var __response = await ActRunsGetAsResponseAsync(
                actorId: actorId,
                offset: offset,
                limit: limit,
                desc: desc,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ListOfRunsResponse>> ActRunsGetAsResponseAsync(
            string actorId,
            double? offset = default,
            double? limit = default,
            bool? desc = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActRunsGetSecurityRequirements,
                operationName: "ActRunsGetAsync");
                ...
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActRunsGet",
                                methodName: "ActRunsGetAsync",
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActRunsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
