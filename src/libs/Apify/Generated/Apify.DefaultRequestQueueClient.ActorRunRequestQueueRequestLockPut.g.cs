...
namespace Apify
{
    public partial class DefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunRequestQueueRequestLockPutSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunRequestQueueRequestLockPutSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunRequestQueueRequestLockPutSecurityRequirement0,
            };
        partial void PrepareActorRunRequestQueueRequestLockPutArguments(
        ...
        partial void PrepareActorRunRequestQueueRequestLockPutRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? clientKey,
            string? forefront);
        partial void ProcessActorRunRequestQueueRequestLockPutResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunRequestQueueRequestLockPutResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.ProlongRequestLockResponse> ActorRunRequestQueueRequestLockPutAsync(
            string runId,
            string requestId,
            double lockSecs,
        ...
        {
            var __response = await ActorRunRequestQueueRequestLockPutAsResponseAsync(
                runId: runId,
                requestId: requestId,
                lockSecs: lockSecs,
                clientKey: clientKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ProlongRequestLockResponse>> ActorRunRequestQueueRequestLockPutAsResponseAsync(
            string runId,
            string requestId,
            double lockSecs,
            string? clientKey = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunRequestQueueRequestLockPutArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunRequestQueueRequestLockPutSecurityRequirements,
                operationName: "ActorRunRequestQueueRequestLockPutAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunRequestQueueRequestLockPut",
                                methodName: "ActorRunRequestQueueRequestLockPutAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunRequestQueueRequestLockPutResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunRequestQueueRequestLockPutResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
