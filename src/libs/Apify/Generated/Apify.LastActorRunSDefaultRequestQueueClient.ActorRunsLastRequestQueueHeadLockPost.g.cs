...
namespace Apify
{
    public partial class LastActorRunSDefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunsLastRequestQueueHeadLockPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunsLastRequestQueueHeadLockPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunsLastRequestQueueHeadLockPostSecurityRequirement0,
            };
        partial void PrepareActorRunsLastRequestQueueHeadLockPostArguments(
        ...
        partial void PrepareActorRunsLastRequestQueueHeadLockPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            double? limit,
            string? clientKey);
        partial void ProcessActorRunsLastRequestQueueHeadLockPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunsLastRequestQueueHeadLockPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.HeadAndLockResponse> ActorRunsLastRequestQueueHeadLockPostAsync(
            string actorId,
            double lockSecs,
        ...
        {
            var __response = await ActorRunsLastRequestQueueHeadLockPostAsResponseAsync(
                actorId: actorId,
                lockSecs: lockSecs,
                status: status,
                origin: origin,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.HeadAndLockResponse>> ActorRunsLastRequestQueueHeadLockPostAsResponseAsync(
            string actorId,
            double lockSecs,
            string? status = default,
            global::Apify.RunOrigin? origin = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunsLastRequestQueueHeadLockPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunsLastRequestQueueHeadLockPostSecurityRequirements,
                operationName: "ActorRunsLastRequestQueueHeadLockPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunsLastRequestQueueHeadLockPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunsLastRequestQueueHeadLockPost",
                                methodName: "ActorRunsLastRequestQueueHeadLockPostAsync",
                                pathTemplate: "$\"/v2/actors/{actorId}/runs/last/request-queue/head/lock\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunsLastRequestQueueHeadLockPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunsLastRequestQueueHeadLockPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
