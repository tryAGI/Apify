...
namespace Apify
{
    public partial class ActorsActorBuildsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorsBuildsPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorsBuildsPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorsBuildsPostSecurityRequirement0,
            };
        partial void PrepareActorsBuildsPostArguments(
        ...
        partial void PrepareActorsBuildsPostRequest(
            global::System.Net.Http.HttpClient httpClient,
        ...
        partial void ProcessActorsBuildsPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorsBuildsPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.BuildResponse> ActorsBuildsPostAsync(
            string actorId,
            string version,
        ...
        {
            var __response = await ActorsBuildsPostAsResponseAsync(
                actorId: actorId,
                version: version,
                useCache: useCache,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.BuildResponse>> ActorsBuildsPostAsResponseAsync(
            string actorId,
            string version,
            bool? useCache = default,
            bool? betaPackages = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorsBuildsPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorsBuildsPostSecurityRequirements,
                operationName: "ActorsBuildsPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorsBuildsPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorsBuildsPost",
                                methodName: "ActorsBuildsPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorsBuildsPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorsBuildsPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
