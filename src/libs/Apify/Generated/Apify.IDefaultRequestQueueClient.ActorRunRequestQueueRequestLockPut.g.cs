...
namespace Apify
{
    public partial interface IDefaultRequestQueueClient
    {
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ProlongRequestLockResponse>> ActorRunRequestQueueRequestLockPutAsResponseAsync(
            string runId,
            string requestId,
            double lockSecs,
            string? clientKey = default,
