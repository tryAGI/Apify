...
namespace Apify
{
    public partial class StorageRequestQueuesRequestsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_RequestQueueRequestsGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_RequestQueueRequestsGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_RequestQueueRequestsGetSecurityRequirement0,
            };
        partial void PrepareRequestQueueRequestsGetArguments(
            ...
            ref double? limit,
            ref string? cursor,
            global::System.Collections.Generic.IList<global::Apify.RequestQueueRequestsGetFilterItem>? filter);
        partial void PrepareRequestQueueRequestsGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? cursor,
            global::System.Collections.Generic.IList<global::Apify.RequestQueueRequestsGetFilterItem>? filter);
        partial void ProcessRequestQueueRequestsGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessRequestQueueRequestsGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.ListOfRequestsResponse> RequestQueueRequestsGetAsync(
            string queueId,
        ...
        {
            var __response = await RequestQueueRequestsGetAsResponseAsync(
                queueId: queueId,
                clientKey: clientKey,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ListOfRequestsResponse>> RequestQueueRequestsGetAsResponseAsync(
            string queueId,
            string? clientKey = default,
            string? exclusiveStartId = default,
            double? limit = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareRequestQueueRequestsGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_RequestQueueRequestsGetSecurityRequirements,
                operationName: "RequestQueueRequestsGetAsync");
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "RequestQueueRequestsGet",
                                methodName: "RequestQueueRequestsGetAsync",
                                pathTemplate: "$\"/v2/request-queues/{queueId}/requests\"",
                                httpMethod: "GET",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessRequestQueueRequestsGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessRequestQueueRequestsGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
