...
namespace Apify
{
    public partial class LastActorRunSDefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunsLastRequestQueueRequestDeleteSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunsLastRequestQueueRequestDeleteSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunsLastRequestQueueRequestDeleteSecurityRequirement0,
            };
        partial void PrepareActorRunsLastRequestQueueRequestDeleteArguments(
        ...
        partial void PrepareActorRunsLastRequestQueueRequestDeleteRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string requestId,
            string? clientKey);
        partial void ProcessActorRunsLastRequestQueueRequestDeleteResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        /// <summary>
        /// Delete request from last run's default request queue<br/>
        /// Deletes a request from the default request queue of the last Actor run.<br/>
        ...
        public async global::System.Threading.Tasks.Task ActorRunsLastRequestQueueRequestDeleteAsync(
            string actorId,
            string requestId,
        ...
        {
            await ActorRunsLastRequestQueueRequestDeleteAsResponseAsync(
                actorId: actorId,
                requestId: requestId,
                status: status,
                origin: origin,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse> ActorRunsLastRequestQueueRequestDeleteAsResponseAsync(
            string actorId,
            string requestId,
            string? status = default,
            global::Apify.RunOrigin? origin = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunsLastRequestQueueRequestDeleteArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunsLastRequestQueueRequestDeleteSecurityRequirements,
                operationName: "ActorRunsLastRequestQueueRequestDeleteAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunsLastRequestQueueRequestDeleteRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunsLastRequestQueueRequestDelete",
                                methodName: "ActorRunsLastRequestQueueRequestDeleteAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunsLastRequestQueueRequestDeleteResponse(
                    httpClient: HttpClient,
