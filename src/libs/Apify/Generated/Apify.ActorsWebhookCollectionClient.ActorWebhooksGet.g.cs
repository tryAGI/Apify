...
namespace Apify
{
    public partial class ActorsWebhookCollectionClient
    {


        private static readonly global::Apify.EndPointSecurityRequirement s_ActorWebhooksGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorWebhooksGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorWebhooksGetSecurityRequirement0,
            };
        partial void PrepareActorWebhooksGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string actorId,
            ref double? offset,
            ref double? limit,
            ref bool? desc);
        partial void PrepareActorWebhooksGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            double? limit,
            bool? desc);
        partial void ProcessActorWebhooksGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorWebhooksGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        /// Gets the list of webhooks of a specific Actor. The response is a JSON with<br/>
        /// the list of objects, where each object contains basic information about a single webhook.<br/>
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.ListOfWebhooksResponse> ActorWebhooksGetAsync(
            string actorId,
        ...
        {
            var __response = await ActorWebhooksGetAsResponseAsync(
                actorId: actorId,
                offset: offset,
                limit: limit,
                desc: desc,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.ListOfWebhooksResponse>> ActorWebhooksGetAsResponseAsync(
            string actorId,
            double? offset = default,
            double? limit = default,
            bool? desc = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorWebhooksGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorWebhooksGetSecurityRequirements,
                operationName: "ActorWebhooksGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorWebhooksGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorWebhooksGet",
                                methodName: "ActorWebhooksGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorWebhooksGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorWebhooksGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Apify.ListOfWebhooksResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Apify.AutoSDKHttpResponse<global::Apify.ListOfWebhooksResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Apify.ListOfWebhooksResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
