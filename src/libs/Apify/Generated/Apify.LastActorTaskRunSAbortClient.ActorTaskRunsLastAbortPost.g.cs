...
namespace Apify
{
    public partial class LastActorTaskRunSAbortClient
    {


        private static readonly global::Apify.EndPointSecurityRequirement s_ActorTaskRunsLastAbortPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorTaskRunsLastAbortPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorTaskRunsLastAbortPostSecurityRequirement0,
            };
        partial void PrepareActorTaskRunsLastAbortPostArguments(
        ...
        partial void ProcessActorTaskRunsLastAbortPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorTaskRunsLastAbortPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorTaskRunsLastAbortPostSecurityRequirements,
                operationName: "ActorTaskRunsLastAbortPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorTaskRunsLastAbortPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorTaskRunsLastAbortPost",
                                methodName: "ActorTaskRunsLastAbortPostAsync",
                                pathTemplate: "$\"/v2/actor-tasks/{actorTaskId}/runs/last/abort\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorTaskRunsLastAbortPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorTaskRunsLastAbortPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
