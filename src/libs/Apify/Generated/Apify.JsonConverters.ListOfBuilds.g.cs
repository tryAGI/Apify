...
{
    /// <inheritdoc />
    public class ListOfBuildsJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Apify.ListOfBuilds>
    {
        /// <inheritdoc />
        public override global::Apify.ListOfBuilds Read(
        ...
        public override void Write(
            ...
            global::Apify.ListOfBuilds value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            if (value.IsListOfBuildsVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Apify.ListOfBuildsVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Apify.ListOfBuildsVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Apify.ListOfBuildsVariant2).Name}");
                var __element1 = global::System.Text.Json.JsonSerializer.SerializeToElement(value.ListOfBuildsVariant2!, typeInfo);
