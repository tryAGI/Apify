...
namespace Apify
{
    public partial interface IActorsActorRunsClient
    {
        ...
        global::System.Threading.Tasks.Task<string> ActRunSyncPostAsync(
            string actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> ActRunSyncPostAsResponseAsync(
            string actorId,
