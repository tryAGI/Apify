...
namespace Apify
{
    public partial class DefaultDatasetClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorRunDatasetItemsGetAsTextSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorRunDatasetItemsGetAsTextSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorRunDatasetItemsGetAsTextSecurityRequirement0,
            };
        partial void PrepareActorRunDatasetItemsGetAsTextArguments(
        ...
        partial void PrepareActorRunDatasetItemsGetAsTextRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? signature);
        partial void ProcessActorRunDatasetItemsGetAsTextResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorRunDatasetItemsGetAsTextResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ActorRunDatasetItemsGetAsTextAsync(
            string runId,
        ...
        {
            var __response = await ActorRunDatasetItemsGetAsTextAsResponseAsync(
                runId: runId,
                format: format,
                clean: clean,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> ActorRunDatasetItemsGetAsTextAsResponseAsync(
            string runId,
            string? format = default,
            bool? clean = default,
            double? offset = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorRunDatasetItemsGetAsTextArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorRunDatasetItemsGetAsTextSecurityRequirements,
                operationName: "ActorRunDatasetItemsGetAsTextAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorRunDatasetItemsGetAsTextRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorRunDatasetItemsGetAsText",
                                methodName: "ActorRunDatasetItemsGetAsTextAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorRunDatasetItemsGetAsTextResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorRunDatasetItemsGetAsTextResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
