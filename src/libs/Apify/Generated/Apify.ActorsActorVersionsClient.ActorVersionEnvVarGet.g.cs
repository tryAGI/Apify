...
namespace Apify
{
    public partial class ActorsActorVersionsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActorVersionEnvVarGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActorVersionEnvVarGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActorVersionEnvVarGetSecurityRequirement0,
            };
        partial void PrepareActorVersionEnvVarGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string actorId,
            ref string versionNumber,
            ref string envVarName);
        partial void PrepareActorVersionEnvVarGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string actorId,
            string versionNumber,
            string envVarName);
        partial void ProcessActorVersionEnvVarGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActorVersionEnvVarGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.EnvVarResponse> ActorVersionEnvVarGetAsync(
            string actorId,
            string versionNumber,
            string envVarName,
        ...
        {
            var __response = await ActorVersionEnvVarGetAsResponseAsync(
                actorId: actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.EnvVarResponse>> ActorVersionEnvVarGetAsResponseAsync(
            string actorId,
            string versionNumber,
            string envVarName,
            global::Apify.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActorVersionEnvVarGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActorVersionEnvVarGetSecurityRequirements,
                operationName: "ActorVersionEnvVarGetAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActorVersionEnvVarGetRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActorVersionEnvVarGet",
                                methodName: "ActorVersionEnvVarGetAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActorVersionEnvVarGetResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActorVersionEnvVarGetResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
