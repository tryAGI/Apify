...
namespace Apify
{
    public partial class StorageDatasetsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_DatasetItemsGetAsTextSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_DatasetItemsGetAsTextSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_DatasetItemsGetAsTextSecurityRequirement0,
            };
        partial void PrepareDatasetItemsGetAsTextArguments(
        ...
        partial void PrepareDatasetItemsGetAsTextRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? signature);
        partial void ProcessDatasetItemsGetAsTextResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessDatasetItemsGetAsTextResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> DatasetItemsGetAsTextAsync(
            string datasetId,
        ...
        {
            var __response = await DatasetItemsGetAsTextAsResponseAsync(
                datasetId: datasetId,
                format: format,
                clean: clean,
                offset: offset,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<string>> DatasetItemsGetAsTextAsResponseAsync(
            string datasetId,
            string? format = default,
            bool? clean = default,
            double? offset = default,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareDatasetItemsGetAsTextArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_DatasetItemsGetAsTextSecurityRequirements,
                operationName: "DatasetItemsGetAsTextAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareDatasetItemsGetAsTextRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "DatasetItemsGetAsText",
                                methodName: "DatasetItemsGetAsTextAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessDatasetItemsGetAsTextResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessDatasetItemsGetAsTextResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
