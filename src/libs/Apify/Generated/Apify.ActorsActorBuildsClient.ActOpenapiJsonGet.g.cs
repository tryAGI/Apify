...
namespace Apify
{
    public partial class ActorsActorBuildsClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActOpenapiJsonGetSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActOpenapiJsonGetSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActOpenapiJsonGetSecurityRequirement0,
            };
        partial void PrepareActOpenapiJsonGetArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string actorId,
            ref string buildId);
        partial void PrepareActOpenapiJsonGetRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string actorId,
            string buildId);
        partial void ProcessActOpenapiJsonGetResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActOpenapiJsonGetResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> ActOpenapiJsonGetAsync(
            string actorId,
            string buildId,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareActOpenapiJsonGetArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActOpenapiJsonGetSecurityRequirements,
                operationName: "ActOpenapiJsonGetAsync");
            ...
            ProcessResponse(
                client: HttpClient,
                response: __response);
            ProcessActOpenapiJsonGetResponse(
                httpClient: HttpClient,
            ...
            if ((int)__response.StatusCode == 404)
            {
                ...
                global::Apify.OneOf<global::Apify.ActorNotFoundError, global::Apify.ActorBuildNotFoundError>? __value_404 = null;
                try
                {
                    if (ReadResponseAsString)
                    {
                        __content_404 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                        __value_404 = global::Apify.OneOf<global::Apify.ActorNotFoundError, global::Apify.ActorBuildNotFoundError>.FromJson(__content_404, JsonSerializerContext);
                    }
                    else
                    {
                        __content_404 = await __response.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                ...
                throw new global::Apify.ApiException<global::Apify.OneOf<global::Apify.ActorNotFoundError, global::Apify.ActorBuildNotFoundError>?>(
            ...
            if (ReadResponseAsString)
            {
                ...
                ProcessActOpenapiJsonGetResponseContent(
                    httpClient: HttpClient,
                    httpResponseMessage: __response,
                    content: ref __content);
