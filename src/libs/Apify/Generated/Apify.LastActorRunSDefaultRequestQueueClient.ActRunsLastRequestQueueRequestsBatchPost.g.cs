...
namespace Apify
{
    public partial class LastActorRunSDefaultRequestQueueClient
    {
        ...
        private static readonly global::Apify.EndPointSecurityRequirement s_ActRunsLastRequestQueueRequestsBatchPostSecurityRequirement0 =
        ...
        private static readonly global::Apify.EndPointSecurityRequirement[] s_ActRunsLastRequestQueueRequestsBatchPostSecurityRequirements =
            new global::Apify.EndPointSecurityRequirement[]
            {                s_ActRunsLastRequestQueueRequestsBatchPostSecurityRequirement0,
            };
        partial void PrepareActRunsLastRequestQueueRequestsBatchPostArguments(
        ...
        partial void PrepareActRunsLastRequestQueueRequestsBatchPostRequest(
            global::System.Net.Http.HttpClient httpClient,
            ...
            string? forefront,
            global::System.Collections.Generic.IList<global::Apify.RequestBase> request);
        partial void ProcessActRunsLastRequestQueueRequestsBatchPostResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessActRunsLastRequestQueueRequestsBatchPostResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Apify.BatchAddResponse> ActRunsLastRequestQueueRequestsBatchPostAsync(
            string actorId,
        ...
        {
            var __response = await ActRunsLastRequestQueueRequestsBatchPostAsResponseAsync(
                actorId: actorId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Apify.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Apify.AutoSDKHttpResponse<global::Apify.BatchAddResponse>> ActRunsLastRequestQueueRequestsBatchPostAsResponseAsync(
            string actorId,
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareActRunsLastRequestQueueRequestsBatchPostArguments(
            ...
            var __authorizations = global::Apify.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_ActRunsLastRequestQueueRequestsBatchPostSecurityRequirements,
                operationName: "ActRunsLastRequestQueueRequestsBatchPostAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareActRunsLastRequestQueueRequestsBatchPostRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Apify.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Apify.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "ActRunsLastRequestQueueRequestsBatchPost",
                                methodName: "ActRunsLastRequestQueueRequestsBatchPostAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessActRunsLastRequestQueueRequestsBatchPostResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Apify.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessActRunsLastRequestQueueRequestsBatchPostResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
